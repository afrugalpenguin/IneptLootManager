...
ILM.L[" profile(s)"] = " profil(s)"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:321
ILM.L["% that will be decayed."] = "% qui sera réduit"
...
ILM.L["%s %% %s decay"] = "%s %% %s Réduction"
-- IneptLootManager_Alerts/Alerts.lua:20
ILM.L["%s %s"] = "%s %s"
-- IneptLootManager/Modules/Loot/LootManager/LootManager.lua:183
ILM.L["%s awarded to %s for %s %s"] = "%s attribué à %s pour %s %s"
-- IneptLootManager/MinimapIcon.lua:39
ILM.L["%s events (%s pending)"] = "%s événements (%s en attente)"
-- IneptLootManager/MinimapIcon.lua:41
ILM.L["%s events (0x%x)"] = "%s événements (0x%x)"
...
ILM.L["%s to be awarded to player when joining roster."] = "%s à attribuer au joueur lorsqu'il rejoint la liste."
-- IneptLootManager/Modules/Auctioning/AutoAssign/GUI.lua:172
ILM.L["%s trade me for %s"] = "%s échanger pour %s"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:143
ILM.L["%s was not found in guild."] = "%s introuvable dans la guilde."
...
ILM.L["40 Player"] = "40 joueurs"
-- IneptLootManager/Modules/Ledger/CrossGuildSyncManager/CrossGuildSyncManager.lua:19
ILM.L["Accept from"] = "Accepter de"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:910
ILM.L["Accepting rolls on %s for %s %s"] = "Prise de rolls sur %s pour %s %s"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:150
ILM.L["Action context"] = "Contexte de l'action"
-- IneptLootManager_Integrations/Integrations.lua:163
ILM.L["Action to take upon Gargul loot award event happening during raid."] = "Action à effectuer lorsqu'un event Gargul d'attribution de loot eu lieu en raid."
...
ILM.L["Add Profiles to Rosters"] = "Ajouter des profils aux rosters"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:129
ILM.L["Add currently selected target to list."] = "ajouter la cible actuellement sélectionnée au roster."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:128
ILM.L["Add target"] = "Ajouter cible"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:149
ILM.L["Add to roster"] = "Ajouter au Roster"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:635
ILM.L["Add to standby"] = "Ajouter en veille"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:396
ILM.L["Add"] = "Ajouté"
-- IneptLootManager_Integrations/Migration.lua:401
ILM.L["Adding %s loot entries for team to %s"] = "Ajout de %s entrées de butin pour l'équipe à %s"
-- IneptLootManager_Integrations/Migration.lua:260
-- IneptLootManager_Integrations/Migration.lua:379
ILM.L["Adding %s profiles to %s"] = "Ajout %s profils à %s"
-- IneptLootManager/Modules/Rosters/RosterManager/RosterManager.lua:1009
ILM.L["Adding missing %s players to current roster"] = "Ajout de %s joueurs manquants au roster actuel"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1368
ILM.L["Additional cost (tax) to add to the award value."] = "Coût supplémentaire (taxe) à ajouter à la valeur de la récompense."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1336
ILM.L["Additional points to be given to players atop of the split value."] = "Points supplémentaires à attribuer aux joueurs en plus de la valeur partagée."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:153
ILM.L["Addon sounds"] = "Sons de l'addon"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:150
ILM.L["Adds selected players to the selected roster (from dropdown)."] = "Ajoute les joueurs sélectionnés au roster sélectionné depuis la liste déroulante."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:213
ILM.L["Advance to next item after bid"] = "Passer à l'objet suivant après l'offre"
-- IneptLootManager/Modules/GUI/UnifiedGUI_History.lua:221
ILM.L["Affected players:"] = "Joueurs concernés:"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:175
ILM.L["Akil'zon"] = "Akil'zon"
...
ILM.L["Algalon the Observer"] = "Algalon l'observateur"
...
ILM.L["All In"] = "Offre max"
-- IneptLootManager_Integrations/Migration.lua:29
ILM.L["All migration entries were commited and executed. Congratulations!"] = "Toutes les entrées de migration ont été validées et exécutées. Toutes nos félicitations!"
...
ILM.L["Allow bidding below minimum points"] = "Permettre d'enchérir en-dessous du minimum de points"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1345
ILM.L["Allow biding more than current standings and ending up with less than minimum standings."] = "Autoriser d'enchérir plus que son capital actuel et terminer avec un capital inférieur au minimum"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1344
ILM.L["Allow biding more than current standings"] = "Permettre de placer une offre supérieure au points actuellement détenus"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1297
ILM.L["Allow equal bids"] = "Autoriser les offres à valeur égale"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:73
ILM.L["Allow going below minimum points"] = "Permettre d'aller en-dessous du minimum de points"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1061
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:156
ILM.L["Allow players to subscribe to the bench through Raids menu"] = "Autoriser les joueurs à se placer sur le banc via le menu Raids"
...
ILM.L["Allow subscription"] = "Autoriser l'abonnement"
...
ILM.L["Always allow 0 bids"] = "Toujours autoriser les offres 0"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1289
ILM.L["Always allow All-In bids"] = "Toujours autoriser les offres all-in"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1281
ILM.L["Always allow Base bids"] = "Toujours autoriser les offres à valeur de base"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1162
ILM.L["Always allow cancel/pass"] = "Toujours autoriser à passer ou annuler"
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:73
ILM.L["Always show"] = "Toujours afficher"
...
ILM.L["Applies all changes and exits sandbox mode"] = "Applique toutes les modifications et quitte le mode Sandbox"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:653
ILM.L["Apply changes"] = "Appliquer les modifications"
...
ILM.L["Archavon the Stone Watcher"] = "Archavon le Gardien des pierres"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:174
ILM.L["Archimonde"] = "Archimonde"
...
ILM.L["Are you sure, you want to award %s to %s for %s %s?"] = "Êtes-vous sûr de vouloir attribuer %s à %s pour %s %s ?"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:542
ILM.L["Are you sure, you want to bid on an unusable item %s?"] = "Êtes-vous sûr, vous souhaitez enchérir sur un article inutilisable %s?"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:360
ILM.L["Are you sure, you want to disenchant %s?"] = "Etes vous sûr de vouloir désenchanter %s?"
-- IneptLootManager/Modules/Profiles/ProfileManager/AltMainLinkingGUI.lua:79
ILM.L["Are you sure, you want to link %s as alt of %s?"] = "Êtes-vous sûr, vous souhaitez lier %s comme alt de %s?"
-- IneptLootManager/Modules/Profiles/ProfileManager/AltMainLinkingGUI.lua:96
ILM.L["Are you sure, you want to unlink %s from its main?"] = "Êtes-vous sûr, vous voulez dissocier %s de sa principale?"
...
ILM.L["Auction length"] = "Durée de l'enchère"
...
ILM.L["Auction of %s items."] = "Enchères de % items"
...
ILM.L["Auction of %s"] = "Enchère de %s"
...
ILM.L["Auction settings"] = "Configuration des enchères"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:690
ILM.L["Auction stopped by the Master Looter"] = "Enchères arrêtées par le maître du butin"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:805
ILM.L["Auction time: %s."] = "Temps de l'enchère: %s."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:285
ILM.L["Auction timer bar font size"] = "Taille de police de la barre timer d'enchère"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:268
ILM.L["Auction timer bar font"] = "Police de la barre timer d'enchère"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:245
ILM.L["Auction timer bar height"] = "Hauteur de la barre timer d'enchère"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:308
ILM.L["Auction timer bar texture"] = "Texture de la barre timer d'enchère"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:222
ILM.L["Auction timer bar width"] = "Largeur de la barre timer d'enchère"
...
ILM.L["Auctioning - History"] = "Vente aux enchères - Historique"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:428
ILM.L["Auctioning - List Filling"] = "Enchères - Remplissage de liste"
...
ILM.L["Auctioning requires active raid or roster mode."] = "Les enchères nécessite un raid actif ou le mode roster"
...
ILM.L["Auctioning"] = "Vente aux enchères"
...
ILM.L["Auto bench leavers"] = "Automatiquement mettre sur le banc les sortants"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:391
ILM.L["Auto-assign from corpse"] = "Assignation automatique depuis le cadavre"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:400
ILM.L["Auto-trade after award"] = "Echange automatique après attribution"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:497
ILM.L["Automatically mark auto-removed items as disenchanted"] = "Marquez automatiquement les éléments de l'auto-rémunération comme désenchanté"
...
ILM.L["Average weeks"] = "Semaines moyennes"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:291
ILM.L["Award %s %s to %s selected players."] = "Attribuer %s %s aux %s joueurs sélectionnés."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:285
ILM.L["Award %s %s to everyone in raid."] = "Attribuer %s %s à tous les membres du raid."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:287
ILM.L["Award %s %s to everyone in roster."] = "Attribuer %s %s à tout le roster."
-- IneptLootManager_Integrations/Integrations.lua:682
ILM.L["Award for Base"] = "Récompense de base"
-- IneptLootManager_Integrations/Integrations.lua:681
ILM.L["Award for Free"] = "Récompense gratuite"
-- IneptLootManager_Integrations/Integrations.lua:685
ILM.L["Award for Large"] = "Récompense grande"
-- IneptLootManager_Integrations/Integrations.lua:686
ILM.L["Award for Max"] = "Récompense Max"
-- IneptLootManager_Integrations/Integrations.lua:684
ILM.L["Award for Medium"] = "Récompense médium"
-- IneptLootManager_Integrations/Integrations.lua:683
ILM.L["Award for Small"] = "Récompense petite"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:164
ILM.L["Award item"] = "Attribuer l'objet"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:981
ILM.L["Award points only to online players"] = "Attribuer des points uniquement aux joueurs en ligne"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:990
ILM.L["Award points only to players in same zone"] = "Attribuer des points uniquement aux joueurs dans la même zone"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:194
ILM.L["Award points to players based on context."] = "Attribuer des points aux joueurs en fonction du contexte."
-- IneptLootManager/Modules/Loot/LootManager/AwardGUI.lua:144
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:183
ILM.L["Award value"] = "Valeur attribuée"
...
ILM.L["Award"] = "Récompense"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:224
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:453
ILM.L["Awarded %s points for %s to all players in raid %s"] = "Attribution de %s points pour %s à tous les joueurs du raid %s"
...
ILM.L["Baltharus the Warborn"] = "Baltharus l'Enfant de la guerre"
...
ILM.L["Baron Geddon"] = "Baron Geddon"
...
ILM.L["Battleguard Sartura"] = "Garde de guerre Sartura"
...
ILM.L["Begin %d days ago, finish today."] = "Début il y a %d jours, fin aujourd'hui."
-- IneptLootManager_Integrations/GUI.lua:248
ILM.L["Begin Day"] = "Jour de début"
-- IneptLootManager_Integrations/GUI.lua:259
ILM.L["Begin Month"] = "Mois de début"
-- IneptLootManager_Integrations/GUI.lua:270
ILM.L["Begin Year"] = "Année de début"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1076
ILM.L["Bench multiplier"] = "Multiplicateur du banc"
...
ILM.L["Bid"] = "Offre d'achat"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1343
ILM.L["Bidding over current standings not allowed"] = "Vous ne pouvez pas faire d’offre supérieure à votre montant actuel de points"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1342
ILM.L["Bidding while below minimum standings not allowed"] = "Vous ne pouvez pas faire d’offre quand vous êtes sous le minimum de points"
...
ILM.L["Boss Kill Bonus"] = "Bonus par boss tué"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1238
ILM.L["Boss kill award values"] = "Valeurs de récompense par boss tué"
...
ILM.L["Can't use"] = "Impossible d'utiliser"
...
ILM.L["Cancel your bid."] = "Annulez votre offre."
...
ILM.L["Cancel"] = "Annuler"
-- IneptLootManager/Modules/Ledger/CrossGuildSyncManager/CrossGuildSyncManager.lua:133
ILM.L["Case-sensitive Player name in the format: Player-RealmName"] = "Nom du joueur sensible à la casse dans le format: Joueur-RealmName"
...
ILM.L["Change migration notes source"] = "Modifier la source des notes de migration"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:822
ILM.L["Change roster name."] = "Changer le nom du Roster."
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:13
ILM.L["Changelog"] = "Journal des modifications"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:286
ILM.L["Changes auction timer bar font size."] = "Modifie la taille de la police de la barre d'enchères."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:269
ILM.L["Changes auction timer bar font."] = "Modifie la police de la barre d'enchères."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:246
ILM.L["Changes auction timer bar height."] = "Modifie la hauteur de la barre de la minuterie d'enchères."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:309
ILM.L["Changes auction timer bar texture."] = "Modifie la texture de la barre de la minuterie d'enchères."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:223
ILM.L["Changes auction timer bar width."] = "Changer la largeur de la barre timer d'enchère"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1353
ILM.L["Changing bid from Main-spec to Off-Spec not allowed"] = "Changer une offre depuis mainspec vers offspec non autorisé"
-- IneptLootManager/Modules/Auctioning/AuctionHistoryManager/AuctionHistoryManager.lua:68
ILM.L["Channel for posting bids."] = "Canal où annoncer les enchères."
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:145
ILM.L["Chess Event"] = "Chess Event"
...
ILM.L["Clear all classes."] = "Effacer toutes les classes."
-- IneptLootManager_Integrations/GUI.lua:473
ILM.L["Clear output"] = "Effacer la sortie"
...
ILM.L["Close on bid"] = "Fermer après l'offre"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:219
ILM.L["Comma-separated (CSV) list of disenchanter names. Case insensitive. Player-RealmName."] = "Liste CSV de désenchanteurs. Sensible à la casse. Joueur-RealmName"
...
ILM.L["Configuration"] = "Configuration"
-- IneptLootManager_Integrations/GenericImport.lua:174
ILM.L["Configure Rosters"] = "Configurer les listes"
...
ILM.L["Copy settings from selected roster."] = "Copier les paramètres du roster sélectionné."
...
ILM.L["Copy settings"] = "Copier les paramètres"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:865
ILM.L["Copy source"] = "Copier la source"
-- IneptLootManager/Modules/Profiles/ProfileInfoManager/ProfileInfoManager.lua:119
ILM.L["Inept Loot Manager %s initialization complete. %s"] = "Inept Loot Manager %s initialisation terminée. %s"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:13
...
ILM.L["Correcting error"] = "Correction d'erreur"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:345
ILM.L["Cosmetics"] = "Produits de beauté"
-- IneptLootManager_Tracker/Auction.lua:9
ILM.L["Count"] = "Comptage"
-- IneptLootManager_Integrations/GenericImport.lua:177
ILM.L["Create Profiles"] = "Créer des profils"
-- IneptLootManager_Integrations/GenericImport.lua:171
ILM.L["Create Rosters"] = "Créer des rosters"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:195
ILM.L["Create new raid with provided name. You will automatically join this raid and leave any other you are part of."] = "Créez un nouveau raid avec le nom fourni. Vous rejoindrez automatiquement ce raid et quitterez tout autre dont vous faites partie."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:500
ILM.L["Create raid %s %s in <%s>"] = "Créer raid %s %s dans <%s>"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:194
ILM.L["Create raid"] = "Créer raid"
...
ILM.L["Creates new roster with default configuration"] = "Crée un nouveau roster avec la configuration par défaut"
-- IneptLootManager_Integrations/Integrations.lua:255
ILM.L["Creates new trigger to be used during RCLC award."] = "Crée un nouveau déclencheur utilisé lors de l'attribution RCLC."
-- IneptLootManager/Modules/Ledger/CrossGuildSyncManager/CrossGuildSyncManager.lua:9
ILM.L["Cross-guild sync"] = "Synchronisation du guild"
-- IneptLootManager/Modules/Ledger/CrossGuildSyncManager/CrossGuildSyncManager.lua:122
ILM.L["Cross-guild synchronisation allows connecting two guild data through proxy mechanism called tunneling. Three types of connection are available: Send to, Accept from or Both. |cff00cc00Accepting data from another player will merge the two guilds databases.|r Use this functionality only if you are absolutely sure you know what you are doing."] = "La synchronisation entre le Guild permet de connecter deux données de guilde via un mécanisme de proxy appelé tunneling. Trois types de connexions sont disponibles: envoyer à, accepter à partir de ou les deux. |cFF00CC00ACCEPTIPT Les données d'un autre joueur fusionnent les deux bases de données de guildes."
...
ILM.L["Danger Zone - Use at own risk"] = "Zone de danger - Utilisation à vos risques et périls"
...
ILM.L["Deathbringer Saurfang"] = "Porte-mort Saurcroc"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:320
ILM.L["Decay %"] = "Réduction %"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:402
ILM.L["Decay %s%% %s to %s selected players."] = "Réduction de %s%% %s aux %s joueurs sélectionnés."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:398
ILM.L["Decay %s%% %s to everyone in roster."] = "Réduction de %s%% %s à tout le roster."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:348
ILM.L["Decay Negatives"] = "La réduction impacte les points négatifs"
...
ILM.L["Decayed %s%% points to %s players in <%s>"] = "Réduction de %s%% points pour %s joueurs dans <%s>"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:461
ILM.L["Decayed %s%% points to all players %s in <%s>"] = "Réduction de %s%% points pour tous les joueurs %s dans <%s>"
-- IneptLootManager_Integrations/GUI.lua:145
ILM.L["December"] = "Décembre"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:910
ILM.L["Default Boss Kill Bonus Value"] = "Valeur par défaut du bonus de Boss tué"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:82
ILM.L["Default Boss Kill Bonus value"] = "Valeur par défaut du bonus de Boss tué"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1213
ILM.L["Default slot values"] = "Valeurs d'emplacement par défaut"
-- .:indirectly
ILM.L["Demon Hunter"] = "Demon Hunter"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:707
ILM.L["Description"] = "Description"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:359
ILM.L["Disable data synchronisation"] = "Désactiver la synchronisation des données"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:360
ILM.L["Disable data synchronisation. This might lead to unexpected consequences. Use this at your own risk. Requires /reload to apply."] = "Désactiver la synchro des données. Peut entraîner des conséquences inattendues. Utilisez à vos risques et périls. Nécessite /reload pour appliquer."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:620
ILM.L["Disable"] = "Désactiver"
-- IneptLootManager/MinimapIcon.lua:54
ILM.L["Disabled"] = "Désactivé"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:37
ILM.L["Disables display of the changelog for any new version."] = "Désactiver l'affichage du changelog pour toute nouvelle version."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:663
ILM.L["Discard changes"] = "Annuler les modifications"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:664
ILM.L["Discards all changes and exits sandbox mode"] = "Ignore toutes les modifications et quitte le mode Sandbox"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:496
ILM.L["Disenchant removed items"] = "Dissenchant les articles supprimés"
-- IneptLootManager_Integrations/Integrations.lua:687
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:344
ILM.L["Disenchant"] = "Désenchanter"
...
ILM.L["Dynamic Item values"] = "Valeur d'objet dynamique"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1037
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1038
...
ILM.L["Emalon the Storm Watcher"] = "Emalon le Guetteur d'orage"
-- IneptLootManager_Integrations/Integrations.lua:118
ILM.L["Enable Gargul integration. This will allow Gargul to take control over some aspects of ILM (starting auction from Gargul, and awarding)."] = "Activer l'intégration de Gargul. Permettra à Gargul de prendre le contrôle de certains aspects de ILM (Démarrer les enchères et attributions via Gargul)."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1155
ILM.L["Enable OS bids"] = "Activer les offres OS"
-- IneptLootManager_Integrations/Integrations.lua:241
ILM.L["Enable RCLC integration. This will allow awarding DKP/GP points on RCLC item award. Requires /reload."] = "Activer l'intégration RCLC. Cela permet de donner des DKP/GP via l'attribution d'objets RCLC. Nécessite /reload."
-- IneptLootManager_Integrations/Integrations.lua:364
ILM.L["Enable WoW DKP Bot Integration. This will result in additional data stored upon logout."] = "Activez l'intégration de WoW DKP Bot. Cela entraînera le stockage de données supplémentaires lors de la déconnexion."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:241
ILM.L["Enable announcing auction start and end."] = "Activer l'annonce de début et fin des enchères."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:179
ILM.L["Enable auto-update bid values when current highest bid changes (open auction only)."] = "Activer la mise à jour automatique des valeurs d'enchères lorsque l'enchère actuelle la plus élevée change (enchère ouverte uniquement)."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:178
ILM.L["Enable auto-update bid values"] = "Activer la mise à jour automatique des valeurs d'enchère"
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:57
ILM.L["Enable item tracking information in tooltip display."] = "Activer le suivi d'objets dans le tooltip"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:392
ILM.L["Enable loot auto-assign (Master Looter UI) from corpse when item is awarded"] = "Active l'assignation automatique du butin (Interface du maitre du butin) depuis le cadavre lorsque l'item est attribué"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1328
ILM.L["Enable paid value splitting amongst raiders."] = "Activez la répartition de la valeur payée entre les raiders."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1282
ILM.L["Enable to allow base bids even if higher bids are present if player didn't bid yet. Affects Open-Ascending Auction."] = "Activer pour autoriser les joueurs n'ayant pas encore fait d'offre à poster des offres à valeur de base même si des offres plus hautes existent déjà"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1298
ILM.L["Enable to allow equal bids. Affects Open-Ascending Auction."] = "Activer pour autoriser les offres à valeur égale. Affecte les enchères ouvertes ascendantes"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1306
ILM.L["Enable to always allow 0 bids. Affects ascending item value mode."] = "Activer pour toujours autoriser les offres 0. Affecte les enchères ascendantes"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1290
ILM.L["Enable to always allow All-In bids. Affects Open-Ascending Auction."] = "Activer pour toujours autoriser les offres all-in. Affecte les enchères ouvertes ascendantes"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1163
ILM.L["Enable to always allow cancelling or passing bids. Affects Open-Ascending Auction."] = "Activer pour toujours autoriser à passer/annuler. Affecte els enchères ouvertes ascendantes"
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:56
ILM.L["Enable tooltip display"] = "Activer l'affichage du tooltip"
-- IneptLootManager/MinimapIcon.lua:83
ILM.L["Enables / disables minimap Icon"] = "Active/désactive l'icône de minimap"
-- IneptLootManager/Modules/Common/Logger/Logger.lua:32
ILM.L["Enables / disables verbose data printing during logging"] = "Active/désactive l'impression de données détaillées dans les logs"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:257
ILM.L["Enables announcing loot awards."] = "Active l'annonce des récompenses de butin."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:265
ILM.L["Enables announcing new highest bid (when applicable)."] = "Active l'annonce de la nouvelle offre la plus élevée (le cas échéant)."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:232
ILM.L["Enables announcing raid start and end."] = "Active l'annonce de début et fin du raid."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:401
ILM.L["Enables auto-trade awarded loot after auctioning from bag"] = "Active l'échange automatique du butin après la vente aux enchères depuis l’inventaire"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:278
ILM.L["Enables displaying item price on tooltip."] = "Active l'affichage du prix en infobulle"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:249
ILM.L["Enables raid-warning countdown for auctions."] = "Active le compte à rebours en avertissement de raid pour les enchères."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:794
ILM.L["End Timetravel"] = "Mettre fin au Timetravel"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:401
ILM.L["End selected raid"] = "Mettre fin au raid sélectionné"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:644
ILM.L["Enter sandbox"] = "Entrer en mode Sandbox"
-- IneptLootManager/Utils.lua:1128
ILM.L["Epic"] = "Épique"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:502
ILM.L["Equation"] = "Equation"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:184
ILM.L["Eredar Twins"] = "Jumelles érédars"
-- IneptLootManager/Modules/Rosters/RosterManager/Roster.lua:870
ILM.L["Europe"] = "Europe"
-- .:indirectly
ILM.L["Evoker"] = "Evoker"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:363
ILM.L["Execute decay for players based on context."] = "Appliquer la réduction aux joueurs en fonction du contexte"
-- IneptLootManager_Integrations/Migration.lua:67
ILM.L["Execute migration again if you are sure this is correct."] = "Exécutez à nouveau la migration si vous êtes sûr que c'est correct."
-- IneptLootManager_Integrations/Migration.lua:512
ILM.L["Execute migration"] = "Exécuter la migration"
-- IneptLootManager_Integrations/Migration.lua:73
ILM.L["Executing Addon Migration with comms disabled."] = "Exécution de la migration des modules complémentaires avec les communications désactivées."
-- IneptLootManager_Integrations/Migration.lua:64
ILM.L["Executing migration even though ledger is not empty."] = "Exécuter la migration même si le grand livre n'est pas vide."
...
ILM.L["Export"] = "Exporter"
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:82
ILM.L["Extend auction bid list with received item count information. Requires reload."] = "Etendre la liste d'enchères avec les informations de comptage d'objets reçues. Requiert un rechargement"
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:65
ILM.L["Extend tooltip with more specific loot information."] = "Etendre le tooltip avec plus d'informations spécifiques au butin"
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:64
ILM.L["Extended tooltip"] = "Tooltip étendu"
-- IneptLootManager/Modules/GUI/Filters.lua:79
ILM.L["External"] = "Externe"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:213
ILM.L["Faction Champions"] = "Champions de faction"
...
ILM.L["Fankriss the Unyielding"] = "Fankriss l'Inflexible"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:154
ILM.L["Fathom-Lord Karathress"] = "Seigneur des fonds Karathress"
-- IneptLootManager_Integrations/GUI.lua:135
ILM.L["February"] = "Février"
...
ILM.L["Fill auction list from corpse"] = "Remplir la liste d'enchère depuis le cadavre"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:433
ILM.L["Fill auction list with items from corpse. Will happen only if you open the corpse loot window."] = "Remplir la liste d'enchère avec les items présents sur le cadavre. Se produira seulement si vous ouvrez la fenêtre de butin du cadavre"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:450
ILM.L["Fill auction list with looted items"] = "Remplir la liste d'enchères avec les items"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:451
ILM.L["Fill auction list with looted items. This will automatically add all items you have received."] = "Remplir la liste d'enchères avec les items. Ajoutera automatiquement tous les items que vous avez reçu"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:104
ILM.L["Fill from Guild"] = "Remplir depuis la guilde"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:116
ILM.L["Fill from Raid Roster"] = "Remplir à partir du groupe de raid"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:442
ILM.L["Fill from corpse only if you are the Loot Master."] = "Remplir depuis le cadavre uniquement si vous êtes maitre du butin"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:460
ILM.L["Fill from loot only if you are using Group Loot."] = "Remplir depuis le butin uniquement si vous utilisez le butin de groupe"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:117
ILM.L["Fill profile list with players in current raid roster."] = "Remplir la liste de profils avec les joueurs dans le groupe de raid."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:105
ILM.L["Fill profile list with players with the minimum level and ranks."] = "Remplir la liste de profils avec les joueurs ayant le niveau et les rangs minimum."
...
ILM.L["Gargul Integration"] = "Intégration Gargul"
...
ILM.L["Gruul the Dragonkiller"] = "Gruul le Tue-dragon"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs_2_TBC.lua:25
ILM.L["Gruul's Lair"] = "Repaire de Gruul"
-- IneptLootManager/Modules/Global/GlobalGuildChangeHandler.lua:18
ILM.L["Guild change detected. Disabling synchronisation until UI reload."] = "Changement de guilde détecté. Désactivation de la synchronisation jusqu'à un rechargement d'interface utilisateur."
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:165
ILM.L["Gurtogg Bloodboil"] = "Gurtogg Fièvresang"
...
ILM.L["Held In Off-hand"] = "Tenu en main gauche"
...
ILM.L["Import complete"] = "Importation terminée"
...
ILM.L["In-Sync"] = "En synchronisation"
...
ILM.L["Include bench"] = "Inclure banc"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:973
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:140
ILM.L["Include benched players in all auto-awards"] = "Inclure les joueurs sur le banc dans toutes les récompenses automatiques"
...
ILM.L["Include cancels in bid list in open auction mode."] = "Incluez les annulations dans la liste des offres en mode d'enchères ouvertes."
...
ILM.L["Include cancels"] = "Inclure les annulations"
...
ILM.L["Include passes in bid list in open auction mode."] = "Inclure des passes dans la liste des offres en mode d'enchères ouvertes."
...
ILM.L["Include passes"] = "Inclure des passes"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:349
ILM.L["Include players with negative standings in decay."] = "Inclure les joueurs avec un total de points négatifs à la réduction"
...
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:345
ILM.L["Include"] = "Inclure"
-- IneptLootManager/MinimapIcon.lua:48
ILM.L["Incoherent state"] = "État incohérent"
...
ILM.L["Information"] = "Information"
-- IneptLootManager_Integrations/ImportCSV.lua:72
ILM.L["Input CSV Item value override data"] = "Entrer les données de remplacement de valeur au format CSV"
-- IneptLootManager_Integrations/GenericImport.lua:198
ILM.L["Input JSON exported standings"] = "Entrer les données exportées en JSON"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:127
ILM.L["Input name: %s"] = "Nom d'entrée: %s"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:115
ILM.L["Instructor Razuvious"] = "Instructeur Razuvious"
-- IneptLootManager_Integrations/IneptLootManager_Integrations.lua:18
ILM.L["Integrations"] = "Intégrations"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:100
ILM.L["Interval Bonus time"] = "Intervalle de temps du bonus"
...
ILM.L["Interval Bonus"] = "Bonus d'intervalle"
...
ILM.L["Interval Time"] = "Intervalle de temps"
...
ILM.L["Interval Value"] = "Valeur du bonus d'intervalle"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:956
ILM.L["Interval in [minutes] to award bonus points"] = "Intervalle en [minutes] pour attribuer des points bonus"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1346
ILM.L["Invalid bid value"] = "Valeur d'enchère non valide"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:396
ILM.L["Invalid context. You should not decay raid only."] = "Contexte non valide. Vous ne devriez pas faire de réduction uniquement sur le raid."
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:16
ILM.L["Invalid item link"] = "Lien d'objet invalide"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1352
ILM.L["Invalid item"] = "Item invalide"
...
ILM.L["Item value mode"] = "Mode de Valeur de l'objet"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:22
ILM.L["Item value must be positive"] = "La valeur de l'objet doit être positive"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1226
ILM.L["Item value overrides"] = "Remplacements de la valeur de l'objet"
...
ILM.L["Lady Deathwhisper"] = "Dame Murmemort"
...
ILM.L["Last month"] = "Le mois dernier"
-- IneptLootManager_Integrations/GUI.lua:314
ILM.L["Last week"] = "La semaine dernière"
-- IneptLootManager_Integrations/GUI.lua:328
ILM.L["Last year"] = "L'année dernière"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:501
ILM.L["Latest loot"] = "Dernier butin"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:524
ILM.L["Latest points"] = "Derniers points"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:305
-- IneptLootManager/Utils.lua:1129
ILM.L["Legendary"] = "Légendaire"
...
ILM.L["Leotheras the Blind"] = "Leotheras l'Aveugle"
...
ILM.L["Lord Jaraxxus"] = "Seigneur Jaraxxus"
...
ILM.L["Lord Marrowgar"] = "Seigneur Gargamoelle"
...
ILM.L["Majordomo Executus"] = "Chambellan Executus"
...
ILM.L["Manual adjustment"] = "Réglage manuel"
...
ILM.L["Master Loot Only"] = "Maitre du butin uniquement"
...
ILM.L["Maximum point cap player can receive per raid week. Set to 0 to disable."] = "Le nombre maximum de points qu’un joueur peut recevoir par semaine de raid. Réglez sur 0 pour désactiver."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1023
ILM.L["Maximum point cap that player can have. Set to 0 to disable."] = "Limite maximale de points qu’un joueur peut avoir. Réglez sur 0 pour désactiver."
...
ILM.L["Migrating %s"] = "Migration de %s"
-- IneptLootManager_Integrations/Migration.lua:89
ILM.L["Migration complete. %s to apply and sync with others or go to %s to discard."] = "Migration terminée. %s pour appliquer et synchroniser avec les autres ou aller à %s pour annuler."
-- IneptLootManager_Integrations/Migration.lua:318
ILM.L["Migration failure: Detected 0 teams"] = "Échec de la migration : 0 équipes détectées"
-- IneptLootManager_Integrations/Migration.lua:256
-- IneptLootManager_Integrations/Migration.lua:372
ILM.L["Migration failure: Unable to create profiles"] = "Échec de la migration : impossible de créer des profils"
-- IneptLootManager_Integrations/Migration.lua:35
ILM.L["Migration ongoing: %s(%s)"] = "Migration en cours : %s(%s)"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:206
ILM.L["Mimiron"] = "Mimiron"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:118
ILM.L["Min bid increment"] = "Incrément d'enchère minimum"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1358
ILM.L["Minimal increment"] = "Incrément minimal"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1359
ILM.L["Minimal value increment for open auction mode."] = "Valeur minimale d’incrément en mode d'enchères ouvertes."
...
ILM.L["Minimum level of players to fill from guild."] = "Niveau minimum des joueurs à remplir depuis guilde."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:139
ILM.L["Minimum points (DKP / EP)"] = "Points minimums (DKP / EP)"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1146
ILM.L["Minimum standing required to be allowed to bid."] = "Capital minimum pour avoir le droit d'enchérir"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1145
ILM.L["Minimum standing"] = "Capital minimum"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:281
ILM.L["Missing award value"] = "Valeur de récompense manquante"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:392
ILM.L["Missing decay value"] = "Valeur de réduction manquante"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:55
ILM.L["Missing profile %s"] = "Profil %s manquant"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:33
ILM.L["Missing roster name and you are not in raid"] = "Nom de roster manquant et vous n'êtes pas en raid"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:37
ILM.L["Missing roster name. Using Raid Info"] = "Nom de roster manquant. Utilisation des informations de raid"
...
ILM.L["Missing valid raid"] = "Raid valide manquant"
...
ILM.L["Modifier combination"] = "Modifier la combinaison de touche"
...
ILM.L["Molten Core"] = "Cœur du Magma"
...
ILM.L["Morogrim Tidewalker"] = "Morogrim Marcheur-des-flots"
...
ILM.L["Mother Shahraz"] = "Mère Shahraz"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:329
ILM.L["Mounts"] = "Montures"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:233
ILM.L["Moving %s from current queue to pending queue."] = "Déplacer %s de la file d'attente actuelle à la file d'attente en attente."
-- IneptLootManager/Modules/GUI/UnifiedGUI_History.lua:444
ILM.L["Multiple"] = "Multiple"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:587
ILM.L["Multiplier for tier %s (if used by the auction type)."] = "Multiplicateur du palier %s (si utilisé par le type d'enchère)."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:510
ILM.L["Multiplier used by the equations"] = "Multiplicateur utilisé par l'équation"
...
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1219
ILM.L["Multiplier"] = "Mutiplicateur"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1195
ILM.L["Multiply auction time by the number of items to increase auction time lineary."] = "Multiplier le temps d'enchères par le nombre d'articles peut augmenter linéairement le temps d'enchères."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1194
ILM.L["Multiply time"] = "Temps de multiplication"
...
ILM.L["Named Buttons"] = "Boutons nommés"
...
ILM.L["Netherspite"] = "Dédain-du-Néant"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:36
ILM.L["Never show changelog"] = "Ne jamais afficher le journal des modifications"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1160
ILM.L["New highest bid on %s: %s %s %s"] = "Nouvelle offre la plus haute %s: %d %s %s"
-- IneptLootManager_Integrations/Migration.lua:47
ILM.L["New migration source for note-based AddOns: %s"] = "Nouvelle source de migration pour les addons basés sur des notes: %s"
-- IneptLootManager_Integrations/GenericImport.lua:104
ILM.L["New roster: %s"] = "Nouveau roster: %s"
-- IneptLootManager_Integrations/Migration.lua:144
ILM.L["New roster: [%s]"] = "Nouveau roster : [%s]"
-- IneptLootManager/Modules/Common/Version/Version.lua:76
ILM.L["New version of Inept Loot Manager is available. For best experience please update the AddOn."] = "La nouvelle version de Inept Loot Manager est disponible. Pour une meilleure expérience, veuillez mettre à jour l'Addon."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:796
ILM.L["Next item"] = "Projet suivant"
...
ILM.L["Nightbane"] = "Plaie-de-nuit"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1348
ILM.L["No auction in progress"] = "Aucune enchère en cours"
...
ILM.L["Non-equippable"] = "Non-équipable"
...
ILM.L["Northrend Beasts"] = "Les bêtes du Norfendre"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1341
ILM.L["Not in a roster"] = "Pas dans un roster"
...
ILM.L["Noth the Plaguebringer"] = "Noth le Porte-peste"
...
ILM.L["Notify that you are passing on the item."] = "Avertissez que vous passez sur l'objet."
-- IneptLootManager_Integrations/GUI.lua:144
ILM.L["November"] = "Novembre"
...
ILM.L["Off Hand"] = "Main gauche"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1351
ILM.L["Off-spec bidding not allowed"] = "Les enchères hors spécifications non autorisées"
-- IneptLootManager_Integrations/Migration.lua:50
ILM.L["Officer notes"] = "Notes d'officier"
...
ILM.L["On Time Bonus Value"] = "Valeur du bonus de début de raid"
...
ILM.L["On Time Bonus"] = "Bonus de début de raid"
...
ILM.L["Onyxia's Lair"] = "Repaire d'Onyxia"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:130
ILM.L["Open Key Bindings UI for AddOns"] = "Ouvrir les raccourcis clavier pour les addons"
-- IneptLootManager/Modules/Auctioning/AutoAssign/GUI.lua:55
ILM.L["Open trade"] = "Ouvrir l'échange"
...
ILM.L["Passing after bidding not allowed"] = "Passer après une enchère n'est pas autorisé"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:108
ILM.L["Patchwerk"] = "Le Recousu"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:321
ILM.L["Patterns"] = "Patrons"
...
ILM.L["Please select a raid"] = "Veuillez sélectionner un raid"
-- IneptLootManager_Integrations/GUI.lua:19
ILM.L["Point History"] = "Historique des points"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1077
ILM.L["Point award multiplier for players on bench."] = "Multiplicateur de récompense pour les joueurs sur le banc"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:998
ILM.L["Point caps"] = "Point caps"
...
ILM.L["Princess Huhuran"] = "Princesse Huhuran"
-- IneptLootManager_Integrations/Integrations.lua:139
-- IneptLootManager_Integrations/Integrations.lua:154
ILM.L["Prioritized"] = "Priorisé"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:224
ILM.L["Professor Putricide"] = "Professeur Putricide"
-- IneptLootManager/Modules/Profiles/ProfileManager/ProfileManager.lua:276
ILM.L["Profile %s already exists and is used by different GUID %s (%s). "] = "Le profil %s existe déjà et est utilisé par un différent GUID %s (%s)."
-- .:indirectly
ILM.L["Profiles"] = "Profils"
-- IneptLootManager/Modules/Points/PointManager/PointManager.lua:523
ILM.L["Progression Bonus"] = "Bonus de progression"
-- IneptLootManager/Modules/Rosters/RosterManager/RosterManager.lua:413
ILM.L["Provide number of raids needed for 100% attendance in a weekly reset. Between 1 - 50 raids. Defaults to 2. Requires /reload."] = "Indiquez le nombre de raids nécessaires pour une participation à 100% lors d'une réinitialisation hebdomadaire. Entre 1 et 50 raids. La valeur par défaut est 2. Nécessite /reload."
-- IneptLootManager/Modules/Rosters/RosterManager/RosterManager.lua:431
ILM.L["Provide number of weeks that will be accounted for attendance. Between 1 - 1000 weeks. Defaults to 10. Requires /reload."] = "Indiquez sur combien de semaines sera calculée la fréquentation. Entre 1 et 1000 semaines. La valeur par défaut est 10. Nécessite /reload."
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:92
ILM.L["Prune profiles"] = "Nettoyer les profils"
-- IneptLootManager_Integrations/Migration.lua:52
ILM.L["Public notes"] = "Notes publiques"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1069
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:148
ILM.L["Put players leaving raid on bench instead of removing them. To remove them completely they will need to be removed manually from the bench."] = "Mettez les joueurs quittant le raid sur le banc au lieu de les retirer. Pour les retirer complètement, ils devront être retirés manuellement du banc."
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:225
ILM.L["Queen Lana'thel"] = "Reine de sang Lana'thel"
...
ILM.L["Ragnaros"] = "Ragnaros"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:246
ILM.L["Raid Completion Bonus Value"] = "Valeur du bonus de fin de raid"
...
ILM.L["Raid management is disabled during time traveling."] = "La gestion des raids est désactivée pendant le Time-traveling"
...
ILM.L["Raids needed in reset"] = "Raids nécessaires à la réinitialisation"
...
ILM.L["Ranged (wands)"] = "À distance (baguettes)"
...
ILM.L["Reliquary of Souls"] = "Reliquaire des âmes"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:276
ILM.L["Remove all items from auction list. Populates new one if there are any pending."] = "Retirer tous les items de la liste d'enchères. Recréé une nouvelle liste si des items sont encore en attente"
...
ILM.L["Remove all"] = "Supprimer tout"
-- IneptLootManager/Modules/Auctioning/AuctionHistoryManager/GUI.lua:80
ILM.L["Remove auction"] = "Supprimer l'enchère"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:729
ILM.L["Remove from roster"] = "Retirer du roster"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:680
ILM.L["Remove from standby"] = "Retirer du mode veille"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:287
ILM.L["Remove item from auction list after it's awarded."] = "Retirer l'item de la liste d'enchères lorsqu'il est attribué"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:488
ILM.L["Remove items without bids from auction list. This will make marking items as disenchanted not possible."] = "Retirez les articles sans offres de la liste des enchères. Cela rendra les articles de marquage comme désenchantés non possibles."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:487
ILM.L["Remove items without bids"] = "Retirer les articles sans offres"
-- IneptLootManager/Modules/Auctioning/AuctionHistoryManager/GUI.lua:93
ILM.L["Remove old"] = "Supprimer l'ancien"
...
ILM.L["Remove on award"] = "Retirer lors de l'attribution"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:644
ILM.L["Remove override"] = "Supprimer le remplacement"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:882
ILM.L["Remove roster"] = "Supprimer le roster"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:434
ILM.L["Remove selected raid"] = "Supprimer le raid sélectionné"
...
ILM.L["Remove selected"] = "Supprimer la sélection"
...
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:396
ILM.L["Remove"] = "Supprimer"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:889
ILM.L["Removes current roster."] = "Supprime le roster actuel."
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:229
ILM.L["Removing %s from current queue."] = "Suppression de %s de la file d'attente actuelle."
...
ILM.L["Removing items not allowed during auction."] = "Interdiction de retirer des objets en cours d'enchère"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:357
ILM.L["Request standby"] = "Demander une mise en veille"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:109
ILM.L["Rescales ILM UI, except Bidding window. You can rescale Bidding window independently by using Ctrl + Mouse Wheel. Some windows may require closing and reopening."] = "Modifie l'échelle d'interface ILM, sauf la fenêtre d'Enchère. Vous pouvez modifier l'échelle de la fenêtre d'enchère indépendamment en utilisant Ctrl + Molette de la souris. Certaines fenêtres devront être fermées et rouvertes."
-- IneptLootManager_Integrations/Integrations.lua:129
-- IneptLootManager_Integrations/Integrations.lua:144
ILM.L["Reserved"] = "Réservée Réservé"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:151
ILM.L["Reset gui positions"] = "Réinitialiser les positions de l'interface graphique"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:335
ILM.L["Restore bar defaults"] = "Restaurer les paramètres de la barre"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:370
ILM.L["Revoke standby"] = "Révoquer la mise en veille"
-- .:indirectly
ILM.L["Rogue"] = "Voleur"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:290
ILM.L["Roll on Loot"] = "Lancer un rand sur butin"
...
ILM.L["Rolling complete"] = "Rolls terminés"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1391
ILM.L["Roster Name"] = "Nom de roster"
...
ILM.L["Search for player names. Separate multiple with a comma ','. Minimum 3 characters. Overrides filtering."] = "Rechercher des noms de joueurs. Séparez les multiples par une virgule ','. 3 caractères minimum. Remplace le filtrage."
-- IneptLootManager/Modules/GUI/Filters.lua:207
ILM.L["Search"] = "Chercher"
...
ILM.L["Select Rosters to display"] = "Sélectionner les rosters à afficher"
-- IneptLootManager_Integrations/GUI.lua:343
ILM.L["Select Rosters to export"] = "Sélectionnez les rosters à exporter"
-- IneptLootManager/Modules/GUI/Filters.lua:179
ILM.L["Select all classes."] = "Sélectionnez toutes les classes."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:291
ILM.L["Select default behavior whenever group loot rolling window gets opened. This will be active only during ILM Raid and while in Raid instance."] = "Sélectionner un comportement par défaut à chaque fois qu'une fenêtre de rand sur butin est ouverte. Ceci ne sera actif qu'en cours de raid ILM ou dans une instance de raid"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:548
ILM.L["Select equation"] = "Sélectionner l'équation"
-- IneptLootManager/Modules/Common/Logger/Logger.lua:23
ILM.L["Select logging level for troubleshooting"] = "Sélectionnez le niveau du journal pour le dépannage"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:204
ILM.L["Select loot rarity for the annoucement to raid."] = "Sélectionnez la rareté du butin annoncé au raid."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:469
ILM.L["Select loot rarity threshold to used to fill the auction list."] = "Sélectionnez le seuil de rareté de butin utilisé pour remplir la liste d'enchères"
-- IneptLootManager/Modules/Loot/LootManager/AwardGUI.lua:249
ILM.L["Select modifier combination for awarding."] = "Sélectionnez la combinaison de modificateurs pour l'attribution."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:478
ILM.L["Select modifier combination for filling auction from bags and corpse."] = "Sélectionnez la combinaison de modificateurs gouvernant le remplissage depuis les sacs et cadavre"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:140
ILM.L["Select roster to add profiles to."] = "Sélectionner le roster auquel ajouter des profils."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:164
ILM.L["Select roster to create raid for."] = "Sélectionner le roster pour lequel créer un raid."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:139
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:163
ILM.L["Select roster"] = "Sélectionner le roster"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1005
ILM.L["Select weekly reset timezone. EU: Wed 07:00 GMT or US: Tue 15:00 GMT"] = "Sélectionnez le fuseau horaire de réinitialisation hebdomadaire. UE : Mercredi 07h00 GMT ou États-Unis : Mar 15h00 GMT"
-- IneptLootManager/Modules/Points/AutoAwardManager/AutoAwardManager.lua:102
ILM.L["Select |cffeeee00%s|r encounter difficulty for bonus value award (%s)."] = "Sélectionner |cffeeee00%s|r difficulté de rencontre pour attribuer une valeur bonus (%s)"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:817
ILM.L["Selected"] = "Sélectionné"
-- IneptLootManager/Modules/Ledger/CrossGuildSyncManager/CrossGuildSyncManager.lua:20
ILM.L["Send to"] = "Envoyer à"
-- IneptLootManager_Integrations/GUI.lua:142
ILM.L["September"] = "Septembre"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs_2_TBC.lua:40
ILM.L["Serpentshrine Cavern"] = "Caverne du sanctuaire du Serpent"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:469
ILM.L["Set %s points to %s players for %s in <%s>"] = "Définir %s points sur %s joueurs pour %s dans <%s>"
-- IneptLootManager_Integrations/GenericImport.lua:183
ILM.L["Set Profiles standings in Rosters"] = "Définir les points des profils dans les rosters"
-- IneptLootManager_Integrations/Migration.lua:411
ILM.L["Set points for %s players for team to %s"] = "Définir des points pour %s joueurs pour l'équipe pour %s"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:185
ILM.L["Set raid name"] = "Définir le nom du raid"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:163
ILM.L["Shade of Akama"] = "Ombre d'Akama"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:143
ILM.L["Shade of Aran"] = "L'ombre d'Aran"
...
ILM.L["Single-Priced"] = "Prix unique"
-- IneptLootManager_Integrations/Migration.lua:212
ILM.L["Skipping %s"] = "%s ignoré"
-- IneptLootManager_Integrations/Migration.lua:288
ILM.L["Skipping CommunityDKP"] = "Ignorer CommunityDKP"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:554
ILM.L["Slot multipliers"] = "Multiplicateurs d'emplacement"
...
ILM.L["Sunwell Plateau"] = "Plateau du Puits de soleil"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:79
ILM.L["Suppresses changelog display until new version is released"] = "Supprimer l'affichage du journal des modifications jusqu'à ce qu'une nouvelle version soit publiée"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:162
ILM.L["Supremus"] = "Supremus"
-- IneptLootManager/MinimapIcon.lua:52
ILM.L["Sync ongoing"] = "Synchronisation en cours"
...
ILM.L["Tempest Keep"] = "Donjon de la Tempête"
...
ILM.L["Thrown"] = "Arme de jet"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:578
ILM.L["Tier multipliers"] = "Multiplicateur de palier"
...
ILM.L["Tiered"] = "Par niveau"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:678
-- IneptLootManager/MinimapIcon.lua:65
ILM.L["Time Traveling"] = "Voyager dans le temps"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1186
ILM.L["Time in seconds by which auction will be extended if bid is received during last 10 seconds."] = "Durée en secondes ajoutée à l’enchère si une offre est reçue au cours des 10 dernières secondes."
...
ILM.L["Timetravel"] = "Timetravel"
-- IneptLootManager/Modules/Auctioning/AuctionHistoryManager/GUI.lua:309
ILM.L["Toggle Auction History window display"] = "Activer l'affichage de la fenêtre Historique des enchères"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:713
ILM.L["Toggle Auctioning window display"] = "Activer l'affichage de la fenêtre d'enchères"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:187
ILM.L["Toggle Bidding auto-open"] = "Activer l'ouverture automatique des enchères"
...
ILM.L["Toggle Bidding window display"] = "Activer l'affichage de la fenêtre d'enchères"
-- IneptLootManager_Integrations/ImportCSV.lua:215
ILM.L["Toggle CSV import window display"] = "Activer l’affichage de la fenêtre d'importation CSV"
-- IneptLootManager/MinimapIcon.lua:82
ILM.L["Toggle Minimap Icon"] = "Afficher l'icône de minimap"
-- IneptLootManager/Modules/Auctioning/AutoAssign/GUI.lua:283
ILM.L["Toggle Trade List window display"] = "Basculer l'affichage de la liste d'échange"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:214
ILM.L["Toggle advancing to next item on the list after bid."] = "Basculer le passage à l'objet suivant dans la liste après l'offre"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:188
ILM.L["Toggle auto open and auto close on auction start and stop"] = "Activer l'ouverture et la fermeture automatiques au début et à l'arrêt des enchères"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:46
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:158
ILM.L["Toggle changelog window display"] = "Activer l'affichage de la fenêtre du journal des modifications"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:45
ILM.L["Toggle changelog"] = "Activer le journal des modifications"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:197
ILM.L["Toggle closing bidding UI after submitting bid for all items."] = "Basculer la fermeture de l'interface après avoir soumis les offres pour tous les items"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:383
ILM.L["Toggle default behavior of remove on award field in auctioning ui"] = "Basculer le comportement par défaut de Supprimer sur le terrain de récompense dans l'interface utilisateur aux enchères"
-- IneptLootManager_Integrations/GUI.lua:512
ILM.L["Toggle export window display"] = "Activer l’affichage de la fenêtre d'exportation"
-- IneptLootManager_Integrations/GenericImport.lua:280
ILM.L["Toggle import window display"] = "Activer l’Affichage de la fenêtre d'importation"
-- IneptLootManager/Modules/GUI/UnifiedGUI.lua:436
ILM.L["Toggle standings window display"] = "Activer l'affichage de la fenêtre de l’aperçu roster"
...
ILM.L["Toggle test bar"] = "Basculer pour montrer un aperçu de la barre timer d'enchère"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:154
ILM.L["Toggles addon sounds."] = "Activer les sons de l'addon"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:346
ILM.L["Toggles auto-rolling on cosmetics."] = "Bascule automatiquement sur les cosmétiques."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:306
ILM.L["Toggles auto-rolling on legendary items."] = "Activer l'auto-rand sur les objets légendaires"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:330
ILM.L["Toggles auto-rolling on mounts."] = "Activer l'auto-rand sur les supports."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:322
ILM.L["Toggles auto-rolling on patterns."] = "Activer l'auto-rand sur les patrons"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:314
ILM.L["Toggles auto-rolling on stacking items."] = "Activer l'auto-rand sur les objets empilables"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:338
ILM.L["Toggles auto-rolling on toys."] = "Activer l'auto-rand sur les jouets."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:374
ILM.L["Toggles loot and point award announcement to guild"] = "Activer l'annonce de récompense de butin à la guilde"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:186
ILM.L["Toggles loot announcement to raid"] = "Activer l'annonce de butin en raid"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:354
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:367
ILM.L["Too much data to display"] = "Trop de données à afficher "
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:197
ILM.L["Toravon the Ice Watcher"] = "Toravon la Sentinelle de glace"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:494
ILM.L["Total blocked"] = "Total bloqué"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:495
ILM.L["Total decayed"] = "Total de points réduits"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:493
ILM.L["Total received"] = "Total reçu"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:492
ILM.L["Total spent"] = "Total dépensé"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:337
ILM.L["Toys"] = "Jouets"
...
ILM.L["Twin Emperors"] = "Les Empereurs jumeaux"
-- IneptLootManager/Modules/Profiles/ProfileManager/ProfileManager.lua:266
ILM.L["Two different profiles exist for target GUID %s (%s:%s) and name %s (%s:%s). Verify and clean up profiles before updating."] = "Deux profils différents existent pour le GUID %s (%s:%s) et le nom %s (%s:%s). Vérifiez et nettoyez les profils avant de mettre à jour."
...
ILM.L["UI Scale"] = "Echelle d'interface"
...
ILM.L["Unable to execute migration. Entries already exist."] = "Impossible d'exécuter la migration. Les entrées existent déjà."
-- IneptLootManager/Modules/Rosters/RosterManager/ItemValueCalculator.lua:169
ILM.L["Unable to get item info from server. Please try auctioning again"] = "Impossible de récupérer les infos de l'objet depuis le serveur. Essayez de relancer l'enchère"
-- IneptLootManager/Utils.lua:1126
ILM.L["Uncommon"] = "Commun"
-- IneptLootManager/Modules/Points/PointManager/PointManager.lua:525
ILM.L["Unexcused absence"] = "Absence injustifiée"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:44
ILM.L["Unknown roster %s"] = "Roster %s inconnu"
-- IneptLootManager/MinimapIcon.lua:56
ILM.L["Unknown sync state"] = "État de synchronisation inconnu"
...
ILM.L["Unlink Alt"] = "Dissocier Reroll"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:280
ILM.L["Unlock selected"] = "Déverrouiller Sélectionné"
-- IneptLootManager_Integrations/Migration.lua:177
ILM.L["UpdatePoints(): Empty targets list"] = "Màj des Points(): Liste de cibles vide"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:515
ILM.L["Updated raid <%s> %s joined, %s left, %s benched, %s removed"] = "Raid <%s> mis à jour %s joueurs ont rejoint, %s joueurs sont partis, %s joueurs sur le banc, %s joueurs ont été supprimés"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1257
ILM.L["Use named buttons"] = "Utiliser les boutons nommés"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:89
ILM.L["Vaelastrasz the Corrupt"] = "Vaelastrasz le Corrompu"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:216
ILM.L["Val'kyr Twins"] = "Les jumelles Val'kyr"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:220
ILM.L["Valithria Dreamwalker"] = "Valithria Marcherêve"
...
ILM.L["Void Reaver"] = "Saccageur du Vide"
...
-- .:indirectly
ILM.L["Warrior"] = "Guerrier"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1013
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:109
ILM.L["Weekly cap"] = "Plafond hebdomadaire"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:485
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:488
ILM.L["Weekly gains"] = "Gains hebdomadaires"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1004
ILM.L["Weekly reset timezone"] = "Timer de réinitialisation hebdomadaire"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:112
ILM.L["Weekly reset"] = "Réinitialisation hebdomadaire"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:195
ILM.L["When enabled, this will make loot announcement display only if you're Master Looter or Raid Leader (if there is no Master Looter)."] = "Quand activé, l'annonce du butin s’affichera uniquement si vous êtes Master Loot ou Raid Leader (s'il n'y a pas de Master Loot)."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1258
ILM.L["Will display names of the buttons instead of values in bidding UI"] = "Affichera les noms des boutons au lieu des valeurs dans l'interface d'enchères"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:359
ILM.L["Will hide bidding window if you enter combat and show it again when you exit. Will also delay auto opening if needed."] = "Masquera la fenêtre d'enchères si vous entrez au combat et affichez-la à nouveau lorsque vous quittez. Retardera également l'ouverture automatique si nécessaire."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:162
ILM.L["Wipe events"] = "Effacer les événements"
-- IneptLootManager/Modules/Common/Logger/Logger.lua:39
ILM.L["Wipe"] = "Effacer"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:163
ILM.L["Wipes all events from memory. This will trigger resyncing from other users."] = "Efface tous les événements de la mémoire. Cela déclenchera la resynchronisation depuis les autres utilisateurs."
-- IneptLootManager/Modules/Common/Logger/Logger.lua:40
ILM.L["Wipes the log history"] = "Efface l'historique du journal"
-- IneptLootManager_Integrations/Integrations.lua:363
ILM.L["WoW DKP Bot Integration"] = "Intégration WoW DKP Bot"
...
ILM.L["You are already in an active raid. Leave or finish it before creating new one."] = "Vous êtes déjà dans un raid actif. Quittez-le ou terminez-le avant d'en créer un nouveau."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:364
ILM.L["You are changing roster settings during active raid. You can continue without any issues however the settings will not get applied until you start a new one."] = "Vous modifiez les paramètres de la liste pendant le raid actif. Vous pouvez continuer sans aucun problème, mais les paramètres ne seront pas appliqués avant d'en démarrer un nouveau."
...
ILM.L["You are not allowed to auction items"] = "Vous n'êtes pas autorisé à mettre d’objets aux enchères"
...
ILM.L["You are not allowed to control raid."] = "Vous n'êtes pas autorisé à contrôler un raid."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:306
ILM.L["You are not allowed to create raids."] = "Vous n'êtes pas autorisé à créer un raid."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:440
ILM.L["You are not allowed to join raid."] = "Vous n'êtes pas autorisé à rejoindre un raid."
...
ILM.L["You are not allowed to start raid."] = "Vous n'êtes pas autorisé à démarrer un raid."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:342
ILM.L["You are not in the raid."] = "Vous n'êtes pas dans le raid."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:700
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:709
ILM.L["You can %s max %d players from standby at the same time to a %s raid."] = "Vous pouvez %s max %d joueurs en attente en même temps à un raid %s."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:655
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:664
ILM.L["You can %s max %d players to standby at the same time to a %s raid."] = "Vous pouvez %s max %d joueurs en attente en même temps à un raid %s."
...
ILM.L["You can only add players to standby of a progressing raid."] = "Vous ne pouvez ajouter des joueurs en attente qu’à un raid en cours."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:646
ILM.L["You can only bench players from same roster as the raid (%s)."] = "Vous ne pouvez mettre sur le banc que des joueurs du même roster que le raid (%s)."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:405
ILM.L["You can only end an active raid."] = "Vous ne pouvez terminer qu'un raid actif."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:444
ILM.L["You can only join an active raid."] = "Vous ne pouvez rejoindre qu'un raid actif."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:448
ILM.L["You can only join different raid than your current one."] = "Vous ne pouvez rejoindre qu’un raid différent de celui que vous avez actuellement."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:691
ILM.L["You can only remove from bench players from same roster as the raid (%s)."] = "Vous ne pouvez retirer du banc que les joueurs du même roster que le raid (%s)."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:333
ILM.L["You can only start a freshly created raid."] = "Vous ne pouvez démarrer qu'un raid fraîchement créé."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:743
ILM.L["You can remove max %d players from roster at the same time."] = "Vous pouvez supprimer un maximum de %d joueurs du roster en même temps."
-- IneptLootManager/Modules/Auctioning/BiddingManager/BiddingManager.lua:345
ILM.L["Your bid (%s) was denied: |cffcc0000%s|r"] = "Votre enchère (%s) a été refusée : |cffcc0000%s|r"
-- IneptLootManager/Modules/Auctioning/BiddingManager/BiddingManager.lua:327
ILM.L["Your bid (%s) was |cff00cc00accepted|r"] = "Votre enchère (%s) a été |cff00cc00acceptée|r"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:64
ILM.L["Zero-Sum Bank Inflation"] = "Inflation de banque Zero-Sum"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1327
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:61
ILM.L["Zero-Sum Bank"] = "Banque Zero-Sum"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1335
ILM.L["Zero-Sum Inflation Value"] = "Valeur d'inflation Zero-Sum"
-- IneptLootManager/Modules/Points/PointManager/PointManager.lua:528
ILM.L["Zero-Sum award"] = "Attribution Zero-Sum"
...
ILM.L["|cffcc0000Your Inept Loot Manager is significantly out of date.|r AddOn communication has been disabled. Please update as soon as possible."] = "|cffcc0000Inept Loot Manager est obsolète.|r La communication de l’addon a été désactivée. Veuillez mettre à jour dès que possible."
end