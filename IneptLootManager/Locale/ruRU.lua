...
ILM.L[" alt of: "] = " альт игрока: "
-- IneptLootManager/Utils.lua:584
ILM.L[" more"] = " подробнее "
...
ILM.L[" profile(s)"] = " профиль(-ей)"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:321
ILM.L["% that will be decayed."] = "% будет сожжено."
...
ILM.L["%s to be awarded to player when joining roster."] = "%s будет вручен игроку при вступлении в состав."
-- IneptLootManager/Modules/Auctioning/AutoAssign/GUI.lua:172
ILM.L["%s trade me for %s"] = "%s открыл трейд для %s"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:143
ILM.L["%s was not found in guild."] = "%s не был найден в гильдии"
...
ILM.L["40 Player"] = "40 человек"
-- IneptLootManager/Modules/Ledger/CrossGuildSyncManager/CrossGuildSyncManager.lua:19
ILM.L["Accept from"] = "Принять из"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:910
ILM.L["Accepting rolls on %s for %s %s"] = "Принятие роллов на %s для %s %s"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:150
ILM.L["Action context"] = "Контекст действия"
-- IneptLootManager_Integrations/Integrations.lua:163
ILM.L["Action to take upon Gargul loot award event happening during raid."] = "Действие, в случае вручения добычи через Gargul loot, во время рейда."
...
ILM.L["Add Profiles to Rosters"] = "Добавить профили в составы"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:129
ILM.L["Add currently selected target to list."] = "Добавить текущую цель в список."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:128
ILM.L["Add target"] = "Добавить цель"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:149
ILM.L["Add to roster"] = "Добавить в состав"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:635
ILM.L["Add to standby"] = "Добавить на замену"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:396
ILM.L["Add"] = "Добавить"
-- IneptLootManager_Integrations/Migration.lua:401
ILM.L["Adding %s loot entries for team to %s"] = "Добавляю %s добычи для состава %s"
-- IneptLootManager_Integrations/Migration.lua:260
-- IneptLootManager_Integrations/Migration.lua:379
ILM.L["Adding %s profiles to %s"] = "Добавляю %s профилей для %s"
-- IneptLootManager/Modules/Rosters/RosterManager/RosterManager.lua:1009
ILM.L["Adding missing %s players to current roster"] = "Добавляю %s отсутствующих игроков в текущий состав"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1368
ILM.L["Additional cost (tax) to add to the award value."] = "Дополнительная стоимость (налог) для добавления к цене вещи."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1336
ILM.L["Additional points to be given to players atop of the split value."] = "Дополнительные очки будут начислены игрокам выше разделяющего значения."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:153
ILM.L["Addon sounds"] = "Звуки аддона"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:150
ILM.L["Adds selected players to the selected roster (from dropdown)."] = "Добавляет выбранных игроков в выбранную список (от выпадения)."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:213
ILM.L["Advance to next item after bid"] = "Перейти к следующему пункту после ставки"
-- IneptLootManager/Modules/GUI/UnifiedGUI_History.lua:221
ILM.L["Affected players:"] = "Затронутые игроки:"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:175
ILM.L["Akil'zon"] = "Акил'зон"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:43
ILM.L["Aku'mai"] = "Аку'май"
...
ILM.L["Algalon the Observer"] = "Алгалон Наблюдатель"
...
ILM.L["All migration entries were commited and executed. Congratulations!"] = "Все мигрированные записи были добавлены. Поздравляем!"
...
ILM.L["Allow bidding below minimum points"] = "Разрешить ставки при отрицательных значениях"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1345
ILM.L["Allow biding more than current standings and ending up with less than minimum standings."] = "Разрешить ставить больше чем текущее количество и таким образом оказаться ниже минимального после."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1344
ILM.L["Allow biding more than current standings"] = "Разрешить ставить больше, чем есть сейчас"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1297
ILM.L["Allow equal bids"] = "Разрешить одинаковые ставки"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:73
ILM.L["Allow going below minimum points"] = "Разрешить уходить в отрицательные значения"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1061
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:156
ILM.L["Allow players to subscribe to the bench through Raids menu"] = "Разрешить игрокам подписываться на замену через меню рейда"
...
ILM.L["Allow subscription"] = "Разрешить подписку"
...
ILM.L["Always allow 0 bids"] = "Всегда разрешать 0 ставки"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1289
ILM.L["Always allow All-In bids"] = "Всегда разрешать All-In ставки"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1281
ILM.L["Always allow Base bids"] = "Всегда разрешать базовую ставку"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1162
ILM.L["Always allow cancel/pass"] = "Всегда разрешать отмена/пасс"
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:73
ILM.L["Always show"] = "Показывать всегда"
...
ILM.L["Applies all changes and exits sandbox mode"] = "Принять все правки и выйти из песочницы"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:653
ILM.L["Apply changes"] = "Принять правки"
...
ILM.L["Are you sure, you want to award %s to %s for %s %s?"] = "Вы уверены, что хотите отдать %s %s за %s %s?"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:542
ILM.L["Are you sure, you want to bid on an unusable item %s?"] = "Вы уверены, вы хотите сделать ставку на непригодную пользу %s?"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:360
ILM.L["Are you sure, you want to disenchant %s?"] = "Вы действительно хотите распылить %s?"
-- IneptLootManager/Modules/Profiles/ProfileManager/AltMainLinkingGUI.lua:79
ILM.L["Are you sure, you want to link %s as alt of %s?"] = "Вы уверены, вы хотите связать %s как alt %s?"
-- IneptLootManager/Modules/Profiles/ProfileManager/AltMainLinkingGUI.lua:96
ILM.L["Are you sure, you want to unlink %s from its main?"] = "Вы уверены, вы хотите отключить %s от его основного?"
...
ILM.L["Auction length"] = "Время аукциона"
...
ILM.L["Auction of %s items."] = "Аукцион %s вещей."
...
ILM.L["Auctioning - History"] = "История торгов"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:428
ILM.L["Auctioning - List Filling"] = "Аукцион - заполнение списка"
...
ILM.L["Auctioning requires active raid or roster mode."] = "Аукцион требует активного рейда или включенного режима аукциона по составу."
...
ILM.L["Award"] = "Начисление"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:224
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:453
ILM.L["Awarded %s points for %s to all players in raid %s"] = "Начислено %s очков за %s всем игрокам в рейде %s"
...
ILM.L["Baltharus the Warborn"] = "Балтар Рожденный в Битве"
...
ILM.L["Battleguard Sartura"] = "Боевой страж Сартура"
...
ILM.L["Begin %d days ago, finish today."] = "Начало %d дней назад, окончание сегодня."
-- IneptLootManager_Integrations/GUI.lua:248
ILM.L["Begin Day"] = "День начала"
-- IneptLootManager_Integrations/GUI.lua:259
ILM.L["Begin Month"] = "Месяц начала"
-- IneptLootManager_Integrations/GUI.lua:270
ILM.L["Begin Year"] = "Год начала"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1076
ILM.L["Bench multiplier"] = "Множитель замены"
...
ILM.L["Bidding over current standings not allowed"] = "Ставки выше текущей позиции невозможны"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1342
ILM.L["Bidding while below minimum standings not allowed"] = "Ставки при отрицательных значениях запрещены"
...
ILM.L["Boss Kill Bonus"] = "За убийство босса"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1238
ILM.L["Boss kill award values"] = "Значение бонуса за убийство босса"
...
ILM.L["Can't use"] = "Не могу использовать"
...
ILM.L["Cancel your bid."] = "Отменить свою ставку."
...
ILM.L["Case-sensitive Player name in the format: Player-RealmName"] = "Чувствительное к корпуам имя игрока в формате: игрока-рилмнаме"
...
ILM.L["Change migration notes source"] = "Изменение источника заметок о миграции"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:822
ILM.L["Change roster name."] = "Изменить название состава."
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:13
ILM.L["Changelog"] = "Лог изменений"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:286
ILM.L["Changes auction timer bar font size."] = "Изменения Аукцион Таймер Бар Бар. Размер шрифта."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:269
ILM.L["Changes auction timer bar font."] = "Изменения Аукцион Таймер Бар шрифт."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:246
ILM.L["Changes auction timer bar height."] = "Изменения аукцион таймер рост бара."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:309
ILM.L["Changes auction timer bar texture."] = "Изменения аукцион Таймер Текстура."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:223
ILM.L["Changes auction timer bar width."] = "Изменение ширины полоски таймера аукциона."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1353
ILM.L["Changing bid from Main-spec to Off-Spec not allowed"] = "Изменение ставки с МС на ОС не разрешено"
-- IneptLootManager/Modules/Auctioning/AuctionHistoryManager/AuctionHistoryManager.lua:68
ILM.L["Channel for posting bids."] = "Канал публикации ставок."
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:145
ILM.L["Chess Event"] = "Шахматный турнир"
...
ILM.L["Chest (robes)"] = "Нагрудник (роба)"
...
ILM.L["Configuration"] = "Настройки"
-- IneptLootManager_Integrations/GenericImport.lua:174
ILM.L["Configure Rosters"] = "Настройте списки"
...
ILM.L["Copy settings from selected roster."] = "Скопировать настройки из текущего состава."
...
ILM.L["Copy settings"] = "Скопировать настройки"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:865
ILM.L["Copy source"] = "Скопировать источник"
-- IneptLootManager/Modules/Profiles/ProfileInfoManager/ProfileInfoManager.lua:119
ILM.L["Inept Loot Manager %s initialization complete. %s"] = "Inept Loot Manager %s загрузка завершена. %s"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:13
...
ILM.L["Crowd Pummeler 9-60"] = "Толпогон 9-60"
...
ILM.L["Decay"] = "Сжигание"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:437
ILM.L["Decayed %s%% points to %s players in <%s>"] = "Сожжено %s%% очков %s игрокам в <%s>"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:461
ILM.L["Decayed %s%% points to all players %s in <%s>"] = "Сожжено %s%% очков всем игрокам %s в <%s>"
-- IneptLootManager_Integrations/GUI.lua:145
ILM.L["December"] = "Декабрь"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:910
ILM.L["Default Boss Kill Bonus Value"] = "Значение по умолчанию за убийство босса"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:82
ILM.L["Default Boss Kill Bonus value"] = "Значение по умолчанию за убийство босса"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1213
ILM.L["Default slot values"] = "Значения слотов по умолчанию"
-- .:indirectly
ILM.L["Demon Hunter"] = "Охотник на демонов"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:707
ILM.L["Description"] = "Описание"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:359
ILM.L["Disable data synchronisation"] = "Отключить синхронизацию данных"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:360
ILM.L["Disable data synchronisation. This might lead to unexpected consequences. Use this at your own risk. Requires /reload to apply."] = "Отключить синхронизацию данных. Это может привести к неожиданным последствиям. Используйте это на свой страх и риск. Для применения требуется /reload."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:620
ILM.L["Disable"] = "Отключить"
-- IneptLootManager/MinimapIcon.lua:54
ILM.L["Disabled"] = "Неполноценный"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:37
ILM.L["Disables display of the changelog for any new version."] = "Отключает отображение истории изменений для любой новой версии."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:663
ILM.L["Discard changes"] = "Отменить изменения"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:664
ILM.L["Discards all changes and exits sandbox mode"] = "Отменить все изменения и выйти из режима песочницы"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:496
ILM.L["Disenchant removed items"] = "Распылить удаленные предметы"
-- IneptLootManager_Integrations/Integrations.lua:687
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:344
ILM.L["Disenchant"] = "Распылить"
...
ILM.L["Dreamscythe and Weaver"] = "Жнец Снов и Ткачик"
-- .:indirectly
ILM.L["Druid"] = "Друид"
...
ILM.L["Dynamic Item values"] = "Динамические цены вещей"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1037
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1038
...
ILM.L["ERROR - invalid import data"] = "ОШИБКА - неверные данные импорта"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:92
ILM.L["Ebonroc"] = "Черноскал"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:129
ILM.L["Edge of Madness"] = "Грань безумия"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:47
ILM.L["Electrocutioner 6000"] = "Электрошокер 6000"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:195
ILM.L["Emalon the Storm Watcher"] = "Эмалон Страж Бури"
-- IneptLootManager_Integrations/Integrations.lua:118
ILM.L["Enable Gargul integration. This will allow Gargul to take control over some aspects of ILM (starting auction from Gargul, and awarding)."] = "Включить интеграцию Gargul. Это позволит Gargul взять под контроль некоторые аспекты ILM (начинать аукцион из Gargul и вручать вещи)."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1155
ILM.L["Enable OS bids"] = "Включить ставки ОС"
-- IneptLootManager_Integrations/Integrations.lua:241
ILM.L["Enable RCLC integration. This will allow awarding DKP/GP points on RCLC item award. Requires /reload."] = "Включает интеграцию с RCLC. Это позволит вручать DKP/GP очки в списках вручения вещей RCLC. Изменения требуют /reload."
-- IneptLootManager_Integrations/Integrations.lua:364
ILM.L["Enable WoW DKP Bot Integration. This will result in additional data stored upon logout."] = "Включить интеграцию с WoW DKP Bot. Это приведет к сохранению дополнительных данных при выходе из игры."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:241
ILM.L["Enable announcing auction start and end."] = "Включает оповещения о старте и стопе аукциона"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:179
ILM.L["Enable auto-update bid values when current highest bid changes (open auction only)."] = "Включить авто обновление ставок, когда меняется текущая высшая ставка (для открытых аукционов)."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:178
ILM.L["Enable auto-update bid values"] = "Включить авто обновление ставок"
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:57
ILM.L["Enable item tracking information in tooltip display."] = "Включить отслеживание вещей в подсказках"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:392
ILM.L["Enable loot auto-assign (Master Looter UI) from corpse when item is awarded"] = "Включить авто-вручение (UI ответственного за добычу) из трупа, когда вещь разыграна"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1328
ILM.L["Enable paid value splitting amongst raiders."] = "Включить разделение оплачиваемой стоимости между рейдерами."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1282
ILM.L["Enable to allow base bids even if higher bids are present if player didn't bid yet. Affects Open-Ascending Auction."] = "Включить разрешение базовой ставки даже если уже есть более высокие ставки от других игроков. Применимо в открытом аукционе с повышением ставок."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1298
ILM.L["Enable to allow equal bids. Affects Open-Ascending Auction."] = "Разрешить одинаковые ставки. Применимо в открытом аукционе с повышением ставок."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1306
ILM.L["Enable to always allow 0 bids. Affects ascending item value mode."] = "Включить разрешение 0 ставок. Применимо в аукционе с повышением ставок."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1290
ILM.L["Enable to always allow All-In bids. Affects Open-Ascending Auction."] = "Включить разрешение All-in ставок. Применимо в открытом аукционе с повышением ставок."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1163
ILM.L["Enable to always allow cancelling or passing bids. Affects Open-Ascending Auction."] = "Включить возможность всегда отменять ставки или пасовать. Влияет только на открытый аукцион."
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:56
ILM.L["Enable tooltip display"] = "Включить отображение описания"
-- IneptLootManager/MinimapIcon.lua:83
ILM.L["Enables / disables minimap Icon"] = "Включает / отключает значок у миникарты"
-- IneptLootManager/Modules/Common/Logger/Logger.lua:32
ILM.L["Enables / disables verbose data printing during logging"] = "Включает / отключает вывод подробных данных при логировании"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:257
ILM.L["Enables announcing loot awards."] = "Включает оповещения вручения наград"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:265
ILM.L["Enables announcing new highest bid (when applicable)."] = "Включает оповещение новой высшей ставки"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:232
ILM.L["Enables announcing raid start and end."] = "Включает оповещения старта и стопа рейда"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:401
ILM.L["Enables auto-trade awarded loot after auctioning from bag"] = "Включить автоматическую передачу вещи в окне обмена после завершения торгов"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:278
ILM.L["Enables displaying item price on tooltip."] = "Включает отображение цены вещи в подсказке."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:249
ILM.L["Enables raid-warning countdown for auctions."] = "Включает оповещения отсчета конца аукциона"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:794
ILM.L["End Timetravel"] = "Завершить путешествие во времени"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:401
ILM.L["End selected raid"] = "Завершить выбранный рейд"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:644
ILM.L["Enter sandbox"] = "Включить песочницу"
-- IneptLootManager/Utils.lua:1128
ILM.L["Epic"] = "Эпическое"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:502
ILM.L["Equation"] = "Уравнение"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:184
ILM.L["Eredar Twins"] = "Эредарские близнецы"
-- IneptLootManager/Modules/Rosters/RosterManager/Roster.lua:870
ILM.L["Europe"] = "Европа"
-- .:indirectly
ILM.L["Evoker"] = "Пробудитель"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:363
ILM.L["Execute decay for players based on context."] = "Выполнить сгорание для игроков на основе контекста."
-- IneptLootManager_Integrations/Migration.lua:67
ILM.L["Execute migration again if you are sure this is correct."] = "Выполните миграцию снова, если вы уверены, что это правильно."
-- IneptLootManager_Integrations/Migration.lua:512
ILM.L["Execute migration"] = "Выполнить миграцию"
-- IneptLootManager_Integrations/Migration.lua:73
ILM.L["Executing Addon Migration with comms disabled."] = "Осуществляю миграцию аддона с выключенной синхронизацией."
-- IneptLootManager_Integrations/Migration.lua:64
ILM.L["Executing migration even though ledger is not empty."] = "Выполнение миграции, хотя книга не пуста."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:532
ILM.L["Exponent / Base"] = "Показатель / база"
...
ILM.L["Export"] = "Экспорт"
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:82
ILM.L["Extend auction bid list with received item count information. Requires reload."] = "Расширить список ставок аукциона количественной информацией. Требует перезагрузку интерфейса."
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:65
ILM.L["Extend tooltip with more specific loot information."] = "Расширить подсказки более точными данными о добыче."
-- IneptLootManager_Tracker/IneptLootManager_Tracker.lua:64
ILM.L["Extended tooltip"] = "Расширенные подсказки"
-- IneptLootManager/Modules/GUI/Filters.lua:79
ILM.L["External"] = "Внешние"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:213
ILM.L["Faction Champions"] = "Чемпионы фракций"
...
ILM.L["Fankriss the Unyielding"] = "Фанкрисс Непреклонный"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:154
ILM.L["Fathom-Lord Karathress"] = "Повелитель глубин Каратресс"
-- IneptLootManager_Integrations/GUI.lua:135
ILM.L["February"] = "Февраль"
...
ILM.L["Felmyst"] = "Пророк Скверны"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:219
ILM.L["Festergut"] = "Тухлопуз"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:53
ILM.L["Festering Rotslime"] = "Гнойная гнилослизь"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:432
ILM.L["Fill auction list from corpse"] = "Заполнять список аукциона из трупа"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:433
ILM.L["Fill auction list with items from corpse. Will happen only if you open the corpse loot window."] = "Заполнять список аукциона вещами из трупа. Произойдет только когда вы откроете окно добычи в трупе."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:450
ILM.L["Fill auction list with looted items"] = "Заполнять список аукциона только полученными вещами"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:451
ILM.L["Fill auction list with looted items. This will automatically add all items you have received."] = "Заполнять список аукциона только полученными вещами. Это автоматически будет добавлять все взятые вами предметы."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:104
ILM.L["Fill from Guild"] = "Заполнить из гильдии"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:116
ILM.L["Fill from Raid Roster"] = "Заполнить из рейда"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:442
ILM.L["Fill from corpse only if you are the Loot Master."] = "Заполнять из трупа только если вы ответственный за добычу"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:460
ILM.L["Fill from loot only if you are using Group Loot."] = "Заполнять полученные вещи, если включена групповая добыча."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:117
ILM.L["Fill profile list with players in current raid roster."] = "Заполнить профили игроками из текущего рейда."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:105
ILM.L["Fill profile list with players with the minimum level and ranks."] = "Заполнить профили игроками с минимальным уровнем и рангом."
...
ILM.L["Heigan the Unclean"] = "Хейган Нечистивый"
...
ILM.L["Import complete"] = "Импорт завершен"
...
ILM.L["Include bench"] = "Учитывать замены"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:973
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:140
ILM.L["Include benched players in all auto-awards"] = "Включить всех игроков на замене в авто получение наград"
...
ILM.L["Include cancels in bid list in open auction mode."] = "Включите отмены в список ставок в режиме открытого аукциона."
...
ILM.L["Include cancels"] = "Включите отмены"
...
ILM.L["Include passes in bid list in open auction mode."] = "Включите пропуски в список ставок в режиме открытого аукциона."
...
ILM.L["Include passes"] = "Включить пасы"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:349
ILM.L["Include players with negative standings in decay."] = "Включите игроков с отрицательным дкп в сгорание."
...
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:345
ILM.L["Include"] = "Включить"
-- IneptLootManager/MinimapIcon.lua:48
ILM.L["Incoherent state"] = "Бессвязный статус"
...
ILM.L["Interval Bonus"] = "Интервальный бонус"
...
ILM.L["Interval Time"] = "Временной интервал"
...
ILM.L["Interval Value"] = "Значение"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:956
ILM.L["Interval in [minutes] to award bonus points"] = "Интервал в [минутах] для присуждения бонуса"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1346
ILM.L["Invalid bid value"] = "Неверное значение ставки"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:396
ILM.L["Invalid context. You should not decay raid only."] = "Неверный контекст. Вы не должны разрушать только рейд."
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:16
ILM.L["Invalid item link"] = "Неверная ссылка на предмет"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1352
ILM.L["Invalid item"] = "Неверный предмет"
...
ILM.L["Item value mode"] = "Режим стоимости вещи"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:22
ILM.L["Item value must be positive"] = "Стоимость вещи должна быть положительная"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1226
ILM.L["Item value overrides"] = "Переназначение стоимости"
...
ILM.L["Last month"] = "Прошлый месяц"
-- IneptLootManager_Integrations/GUI.lua:314
ILM.L["Last week"] = "Прошлая неделя"
-- IneptLootManager_Integrations/GUI.lua:328
ILM.L["Last year"] = "Прошлый год"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:501
ILM.L["Latest loot"] = "Последняя добыча"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:524
ILM.L["Latest points"] = "Последние очки"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:305
-- IneptLootManager/Utils.lua:1129
ILM.L["Legendary"] = "Легендарное"
...
ILM.L["Leotheras the Blind"] = "Леотерас Слепец"
...
ILM.L["Lord Jaraxxus"] = "Лорд Джараксус"
...
ILM.L["Lord Marrowgar"] = "Лорд Ребрад"
...
ILM.L["Majordomo Executus"] = "Мажордом Экзекутус"
...
ILM.L["Master Loot Only"] = "Только если ответственный за добычу"
...
ILM.L["Maximum point cap player can receive per raid week. Set to 0 to disable."] = "Кап очков, которые игрок может набрать за рейдовую неделю. Поставьте 0 для отключения."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1023
ILM.L["Maximum point cap that player can have. Set to 0 to disable."] = "Кап очков, которые могут быть у игрока. Поставьте 0 для отключения."
...
ILM.L["Mechanical Menagerie"] = "Механический зверинец"
...
ILM.L["Migrating %s"] = "Мигрирую %s"
-- IneptLootManager_Integrations/Migration.lua:89
ILM.L["Migration complete. %s to apply and sync with others or go to %s to discard."] = "Миграция завершена. %s для принятия и синхронизации или %s для отмены."
-- IneptLootManager_Integrations/Migration.lua:318
ILM.L["Migration failure: Detected 0 teams"] = "Миграция прервана: Найдено 0 команд"
-- IneptLootManager_Integrations/Migration.lua:256
-- IneptLootManager_Integrations/Migration.lua:372
ILM.L["Migration failure: Unable to create profiles"] = "Миграция прервана: Не могу создать профили"
-- IneptLootManager_Integrations/Migration.lua:35
ILM.L["Migration ongoing: %s(%s)"] = "Миграция в процессе: %s(%s)"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:206
ILM.L["Mimiron"] = "Мимирон"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:118
ILM.L["Min bid increment"] = "Мин увеличение ставки"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1358
ILM.L["Minimal increment"] = "Минимальное увеличение"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1359
ILM.L["Minimal value increment for open auction mode."] = "Минимальное увеличение ставки для открытых аукционов."
-- IneptLootManager_Integrations/Migration.lua:91
ILM.L["Minimap Icon -> Configuration -> Wipe events"] = "Иконка на карте -> Настройки -> Стереть"
...
ILM.L["Minimum Level"] = "Минимальный уровень"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:92
ILM.L["Minimum level of players to fill from guild."] = "Минимальный уровень игроков для заполнения из гильдии."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:139
ILM.L["Minimum points (DKP / EP)"] = "Минимальные очки (DKP / EP)"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1146
ILM.L["Minimum standing required to be allowed to bid."] = "Минимальное количество необходимое для разрешения ставки."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1145
ILM.L["Minimum standing"] = "Минимальное количество"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:281
ILM.L["Missing award value"] = "Отсутствует цена выдачи"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:392
ILM.L["Missing decay value"] = "Отсутствует значение сгорания"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:55
ILM.L["Missing profile %s"] = "Отсутствует профиль %s"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:33
ILM.L["Missing roster name and you are not in raid"] = "Отсутствует название состава и вы не в рейде"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:37
ILM.L["Missing roster name. Using Raid Info"] = "Отсутствует название состава. Использую инфо из рейда"
...
ILM.L["Missing valid raid"] = "Отсутствует корректный рейд"
...
ILM.L["Modifier combination"] = "Комбинация модификатора"
...
ILM.L["Molten Core"] = "Огненные Недра"
...
ILM.L["Morogrim Tidewalker"] = "Морогрим Волноступ"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:57
ILM.L["Morphaz and Hazzas"] = "Морфаз и Хаззас"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:167
ILM.L["Mother Shahraz"] = "Матушка Шахраз"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:329
ILM.L["Mounts"] = "Крепления"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:233
ILM.L["Moving %s from current queue to pending queue."] = "Перемещение %s от текущей очереди в ожидание очереди."
-- IneptLootManager/Modules/GUI/UnifiedGUI_History.lua:444
ILM.L["Multiple"] = "Несколько"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:587
ILM.L["Multiplier for tier %s (if used by the auction type)."] = "Мультипликатор для тира %s (если используется вашим типом аукциона)"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:510
ILM.L["Multiplier used by the equations"] = "Мультипликатор используемый в уравнении"
...
ILM.L["Named Buttons"] = "Названные кнопки"
...
ILM.L["Netherspite"] = "Гнев Пустоты"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:36
ILM.L["Never show changelog"] = "Никогда не показывать изменения"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1160
ILM.L["New highest bid on %s: %s %s %s"] = "Новая наивысшая ставка на %s: %s %s %s"
-- IneptLootManager_Integrations/Migration.lua:47
ILM.L["New migration source for note-based AddOns: %s"] = "Новый источник миграции для Addons на основе нот: %s"
-- IneptLootManager_Integrations/GenericImport.lua:104
ILM.L["New roster: %s"] = "Новый состав: %s"
-- IneptLootManager_Integrations/Migration.lua:144
ILM.L["New roster: [%s]"] = "Новый состав: [%s]"
-- IneptLootManager/Modules/Common/Version/Version.lua:76
ILM.L["New version of Inept Loot Manager is available. For best experience please update the AddOn."] = "Новая версия Inept Loot Manager доступна. Для лучшего опыта использования, пожалуйста, обновите аддон."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:796
ILM.L["Next item"] = "Следующий проект"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:795
ILM.L["Next"] = "Следующий"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:147
ILM.L["Nightbane"] = "Ночная Погибель"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1348
ILM.L["No auction in progress"] = "Нет аукционов в процессе"
...
ILM.L["Non-equippable"] = "Неодеваемое"
...
ILM.L["Noth the Plaguebringer"] = "Нот Чумной"
...
ILM.L["Notify that you are passing on the item."] = "Уведомьте, что вы пасуете на предмет."
-- IneptLootManager_Integrations/GUI.lua:144
ILM.L["November"] = "Ноябрь"
...
ILM.L["Off Hand"] = "Левая рука"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:1351
ILM.L["Off-spec bidding not allowed"] = "Ставки на офф-спек не разрешены."
-- IneptLootManager_Integrations/Migration.lua:50
ILM.L["Officer notes"] = "Офицер записи"
...
ILM.L["On Time Bonus Value"] = "Значение бонуса за приход вовремя"
...
ILM.L["On Time Bonus"] = "Приход вовремя"
...
ILM.L["Onyxia's Lair"] = "Логово Ониксии"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:130
ILM.L["Open Key Bindings UI for AddOns"] = "Открыть интерфейс назначения клавиш для аддонов"
-- IneptLootManager/Modules/Auctioning/AutoAssign/GUI.lua:55
ILM.L["Open trade"] = "Открыть торговлю"
...
ILM.L["Overrides"] = "Ручная коррекция"
...
-- .:indirectly
ILM.L["Paladin"] = "Паладин"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:288
ILM.L["Participated"] = "Участвовавшие"
...
ILM.L["Passing after bidding not allowed"] = "Пас после ставки запрещен"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:108
ILM.L["Patchwerk"] = "Лоскутик"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:321
ILM.L["Patterns"] = "Рецепты"
...
ILM.L["Please select a raid"] = "Выберите рейд"
-- IneptLootManager_Integrations/GUI.lua:19
ILM.L["Point History"] = "История ДКП"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1077
ILM.L["Point award multiplier for players on bench."] = "Множитель очков для игроков на скамейке."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:998
ILM.L["Point caps"] = "Лимит очков"
...
ILM.L["Princess Huhuran"] = "Принцесса Хухуран"
-- IneptLootManager_Integrations/Integrations.lua:139
-- IneptLootManager_Integrations/Integrations.lua:154
ILM.L["Prioritized"] = "Приоритет"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:224
ILM.L["Professor Putricide"] = "Профессор Мерзоцид"
-- IneptLootManager/Modules/Profiles/ProfileManager/ProfileManager.lua:276
ILM.L["Profile %s already exists and is used by different GUID %s (%s). "] = "Профиль %s уже существует и используется различными GUID %s ( %s)."
-- .:indirectly
ILM.L["Profiles"] = "Профили"
-- IneptLootManager/Modules/Points/PointManager/PointManager.lua:523
ILM.L["Progression Bonus"] = "Бонус за прогресс"
-- IneptLootManager/Modules/Rosters/RosterManager/RosterManager.lua:413
ILM.L["Provide number of raids needed for 100% attendance in a weekly reset. Between 1 - 50 raids. Defaults to 2. Requires /reload."] = "Количество рейдов, необходимых в неделю для получения 100% посещения. Значение от 1 до 50. По умолчанию 2. Требуется /reload"
-- IneptLootManager/Modules/Rosters/RosterManager/RosterManager.lua:431
ILM.L["Provide number of weeks that will be accounted for attendance. Between 1 - 1000 weeks. Defaults to 10. Requires /reload."] = "Количество недель, по которым будет высчитываться посещаемость. Значение от 1 до 1000. По умолчанию 10. Требуется /reload"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:92
ILM.L["Prune profiles"] = "Удалить профили"
-- IneptLootManager_Integrations/Migration.lua:52
ILM.L["Public notes"] = "Публичные заметки"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1069
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:148
ILM.L["Put players leaving raid on bench instead of removing them. To remove them completely they will need to be removed manually from the bench."] = "Добавить игроков, которые вышли из рейда на замену, вместо того, чтобы удалять их совсем. Для того, чтобы удалить совсем - необходимо вручную удалить из замены"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:225
ILM.L["Queen Lana'thel"] = "Королева Лана'Тель"
...
ILM.L["RCLC Integration"] = "Интеграция с RCLC"
...
ILM.L["Rage Winterchill"] = "Лютый Хлад"
...
ILM.L["Ragnaros"] = "Рагнарос"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:246
ILM.L["Raid Completion Bonus Value"] = "Значение бонуса за пройденный рейд"
...
ILM.L["Raid management is disabled during time traveling."] = "Управление рейдом выключено в режиме путешествия во времени."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:819
ILM.L["Raid"] = "Рейд"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:39
ILM.L["Raid: %s Roster: %s"] = "Рейд: %s Состав: %s"
-- IneptLootManager/Modules/Rosters/RosterManager/RosterManager.lua:412
ILM.L["Raids needed in reset"] = "Рейдов за неделю"
...
ILM.L["Received"] = "Получено"
-- IneptLootManager_Integrations/Integrations.lua:134
-- IneptLootManager_Integrations/Integrations.lua:149
ILM.L["Regular"] = "Обычный"
...
ILM.L["Relic"] = "Реликвия"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:166
ILM.L["Reliquary of Souls"] = "Реликварий Потерянных"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:276
ILM.L["Remove all items from auction list. Populates new one if there are any pending."] = "Удалить все вещи из списка аукциона. Добавит новые если они есть в очереди ожидания."
...
ILM.L["Remove all"] = "Удалить все"
-- IneptLootManager/Modules/Auctioning/AuctionHistoryManager/GUI.lua:80
ILM.L["Remove auction"] = "Удалить аукцион"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:729
ILM.L["Remove from roster"] = "Удалить из состава"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:680
ILM.L["Remove from standby"] = "Удалить с замены"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:287
ILM.L["Remove item from auction list after it's awarded."] = "Удалить вещь из списка аукциона после ее вручения."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:488
ILM.L["Remove items without bids from auction list. This will make marking items as disenchanted not possible."] = "Удалить предметы без ставок из списка аукциона. Это сделает невозможным маркировку предметов как распыленных."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:487
ILM.L["Remove items without bids"] = "Удалить предметы без ставок"
-- IneptLootManager/Modules/Auctioning/AuctionHistoryManager/GUI.lua:93
ILM.L["Remove old"] = "Удалить старое"
...
ILM.L["Remove selected"] = "Удалить выбранное"
...
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:396
ILM.L["Remove"] = "Удалить"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:889
ILM.L["Removes current roster."] = "Удалить текущий состав."
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:229
ILM.L["Removing %s from current queue."] = "Удаление %s из текущей очереди."
...
ILM.L["Removing items not allowed during auction."] = "Удаление вещей запрещено во время аукциона."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:357
ILM.L["Request standby"] = "Запрос замены"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:109
ILM.L["Rescales ILM UI, except Bidding window. You can rescale Bidding window independently by using Ctrl + Mouse Wheel. Some windows may require closing and reopening."] = "Rescales ILM UI, кроме окна торгов. Вы можете самостоятельно изменить окно торгов независимо, используя колесо CTRL + мыши. Некоторые окна могут потребовать закрытия и повторного открытия."
-- IneptLootManager_Integrations/Integrations.lua:129
-- IneptLootManager_Integrations/Integrations.lua:144
ILM.L["Reserved"] = "Сдержанный"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:151
ILM.L["Reset gui positions"] = "Сброс позиционирования интерфейса"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:335
ILM.L["Restore bar defaults"] = "Восстановить по умолчанию"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:370
ILM.L["Revoke standby"] = "Отзыв замены"
-- .:indirectly
ILM.L["Rogue"] = "Разбойник"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:290
ILM.L["Roll on Loot"] = "Роллить на добычу"
...
ILM.L["Sealed"] = "Запечатано"
-- IneptLootManager/Modules/GUI/Filters.lua:208
ILM.L["Search for player names. Separate multiple with a comma ','. Minimum 3 characters. Overrides filtering."] = "Поиск имен игроков. Разделите нескольких игроков запятой "
...
ILM.L["Select Profiles to export"] = "Выбор профилей для экспорта"
-- IneptLootManager/Modules/Rosters/RosterManager/RosterManager.lua:448
ILM.L["Select Rosters to display"] = "Выбрать составы для отображения"
-- IneptLootManager_Integrations/GUI.lua:343
ILM.L["Select Rosters to export"] = "Выбор составов для экспорта"
-- IneptLootManager/Modules/GUI/Filters.lua:179
ILM.L["Select all classes."] = "Выбрать все классы."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:291
ILM.L["Select default behavior whenever group loot rolling window gets opened. This will be active only during ILM Raid and while in Raid instance."] = "Выбрать поведение по умолчанию при открытии окна ролла добычи. Это будет активно только во время активного ILM рейда и только внутри рейдового подземелья."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:548
ILM.L["Select equation"] = "Выберите уравнение"
-- IneptLootManager/Modules/Common/Logger/Logger.lua:23
ILM.L["Select logging level for troubleshooting"] = "Выберите уровень логирования для поиска проблем"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:204
ILM.L["Select loot rarity for the annoucement to raid."] = "Выбрать редкость добычи для оповещений."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:469
ILM.L["Select loot rarity threshold to used to fill the auction list."] = "Выбрать редкость предметов для добавления в список аукциона."
-- IneptLootManager/Modules/Loot/LootManager/AwardGUI.lua:249
ILM.L["Select modifier combination for awarding."] = "Выберите комбинацию модификатора для награждения."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:478
ILM.L["Select modifier combination for filling auction from bags and corpse."] = "Выбрать комбинации для заполнения списка аукциона из сумок и трупа."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:140
ILM.L["Select roster to add profiles to."] = "Выберите состав для добавления профилей."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:164
ILM.L["Select roster to create raid for."] = "Выберите состав для создания рейда."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:139
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:163
ILM.L["Select roster"] = "Выберите состав"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1005
ILM.L["Select weekly reset timezone. EU: Wed 07:00 GMT or US: Tue 15:00 GMT"] = "Выберете часовой пояс недельного сброса. EU: Среда 07:00 GMT или US: Вторник 15:00 GMT"
-- IneptLootManager/Modules/Points/AutoAwardManager/AutoAwardManager.lua:102
ILM.L["Select |cffeeee00%s|r encounter difficulty for bonus value award (%s)."] = "Выбор |cffeeee00%s|r столкнулся с трудностью для получения бонусной награды (%s)."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:817
ILM.L["Selected"] = "Выбранный"
-- IneptLootManager/Modules/Ledger/CrossGuildSyncManager/CrossGuildSyncManager.lua:20
ILM.L["Send to"] = "Отправить"
-- IneptLootManager_Integrations/GUI.lua:142
ILM.L["September"] = "Сентябрь"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs_2_TBC.lua:40
ILM.L["Serpentshrine Cavern"] = "Змеиное святилище"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:469
ILM.L["Set %s points to %s players for %s in <%s>"] = "Начислить %s очки для %s игроков за %s в <%s>"
-- IneptLootManager_Integrations/GenericImport.lua:183
ILM.L["Set Profiles standings in Rosters"] = "Установить ранги профилей в составе"
-- IneptLootManager_Integrations/Migration.lua:411
ILM.L["Set points for %s players for team to %s"] = "Начислить очки для %s игроков в команде с %s"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Raids.lua:185
ILM.L["Set raid name"] = "Установить имя рейда"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:163
ILM.L["Shade of Akama"] = "Тень Акамы"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:143
ILM.L["Shade of Aran"] = "Тень Арана"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:58
ILM.L["Shade of Eranikus"] = "Тень Эраникуса"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:190
ILM.L["Shadron"] = "Шадрон"
-- .:indirectly
ILM.L["Shaman"] = "Шаман"
...
ILM.L["Single-Priced"] = "Фиксированная"
-- IneptLootManager_Integrations/Migration.lua:212
ILM.L["Skipping %s"] = "Пропускаю %s"
-- IneptLootManager_Integrations/Migration.lua:288
ILM.L["Skipping CommunityDKP"] = "Пропускаю CommunityDKP"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:554
ILM.L["Slot multipliers"] = "Мультипликаторы для слота"
...
ILM.L["Store bids"] = "Хранить ставки"
-- IneptLootManager/Modules/Auctioning/AuctionHistoryManager/AuctionHistoryManager.lua:60
ILM.L["Store finished auction bids information."] = "Хранить информацию по ставкам в завершенных торгах."
...
ILM.L["Tempest Keep"] = "Крепость Бурь"
...
ILM.L["Thrown"] = "Метательное"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:578
ILM.L["Tier multipliers"] = "Мультипликаторы для тира"
...
ILM.L["Tiered"] = "Многоуровневый"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:678
-- IneptLootManager/MinimapIcon.lua:65
ILM.L["Time Traveling"] = "Путешествую во времени"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1186
ILM.L["Time in seconds by which auction will be extended if bid is received during last 10 seconds."] = "Время в секундах на которое будет продлен аукцион, если ставка будет сделана в последние 10 секунд."
...
ILM.L["Timetravel"] = "Путешествие"
-- IneptLootManager/Modules/Auctioning/AuctionHistoryManager/GUI.lua:309
ILM.L["Toggle Auction History window display"] = "Включить отображение окна истории торгов"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:713
ILM.L["Toggle Auctioning window display"] = "Включить отображения окна ставок"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:187
ILM.L["Toggle Bidding auto-open"] = "Включить авто-открытие ставок"
...
ILM.L["Toggle Bidding window display"] = "Включить отображение окна ставок"
-- IneptLootManager_Integrations/ImportCSV.lua:215
ILM.L["Toggle CSV import window display"] = "Переключить дисплей импорта CSV"
-- IneptLootManager/MinimapIcon.lua:82
ILM.L["Toggle Minimap Icon"] = "Переключить иконку минимума"
-- IneptLootManager/Modules/Auctioning/AutoAssign/GUI.lua:283
ILM.L["Toggle Trade List window display"] = "Включить отображение списка для передачи"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:214
ILM.L["Toggle advancing to next item on the list after bid."] = "Переверните, продвигаясь к следующему элементу в списке после ставки."
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:188
ILM.L["Toggle auto open and auto close on auction start and stop"] = "Включить авто-открытие и закрытие окна при начале и окончании аукциона"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:46
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:158
ILM.L["Toggle changelog window display"] = "Включить отображение окна лога изменений"
-- IneptLootManager/Modules/Common/Changelog/GUI.lua:45
ILM.L["Toggle changelog"] = "Включить лог изменений"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:197
ILM.L["Toggle closing bidding UI after submitting bid for all items."] = "Активировать закрытие окна ставок после проставления ставок на все вещи."
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:383
ILM.L["Toggle default behavior of remove on award field in auctioning ui"] = "Переключить поведение по умолчанию по полю"
-- IneptLootManager_Integrations/GUI.lua:512
ILM.L["Toggle export window display"] = "Включить отображение окна экспорта"
-- IneptLootManager_Integrations/GenericImport.lua:280
ILM.L["Toggle import window display"] = "Включить отображение окна импорта"
-- IneptLootManager/Modules/GUI/UnifiedGUI.lua:436
ILM.L["Toggle standings window display"] = "Включить отображение окна составов"
...
ILM.L["Trinket"] = "Аксессуар"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:37
ILM.L["True"] = "Верно"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:42
ILM.L["Twilight Lord Kelris"] = "Повелитель сумрака Келрис"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:102
ILM.L["Twin Emperors"] = "Императоры-близнецы"
-- IneptLootManager/Modules/Profiles/ProfileManager/ProfileManager.lua:266
ILM.L["Two different profiles exist for target GUID %s (%s:%s) and name %s (%s:%s). Verify and clean up profiles before updating."] = "Существуют два разных профиля для целевого GUID %s (%s:%s) и имя%s (%s:%s). Проверьте и очистите профили перед обновлением."
...
ILM.L["Unable to execute migration. Entries already exist."] = "Невозможно выполнить миграцию. Записи уже существуют."
-- IneptLootManager/Modules/Rosters/RosterManager/ItemValueCalculator.lua:169
ILM.L["Unable to get item info from server. Please try auctioning again"] = "Не могу получить информацию о вещи от сервера. Попробуйте начать аукцион заново"
-- IneptLootManager/Utils.lua:1126
ILM.L["Uncommon"] = "Необычное"
-- IneptLootManager/Modules/Points/PointManager/PointManager.lua:525
ILM.L["Unexcused absence"] = "Отсутствие"
-- IneptLootManager/Modules/Global/GlobalSlashCommands.lua:44
ILM.L["Unknown roster %s"] = "Неизвестный состав %s"
-- IneptLootManager/MinimapIcon.lua:56
ILM.L["Unknown sync state"] = "Статус синхронизации неизвестен"
...
ILM.L["Unlink Alt"] = "Отвязать альта"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Profiles.lua:280
ILM.L["Unlock selected"] = "Разблокировать выбранное"
-- IneptLootManager_Integrations/Migration.lua:177
ILM.L["UpdatePoints(): Empty targets list"] = "ОбновитьОчки(): Пустой список целей"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:515
ILM.L["Updated raid <%s> %s joined, %s left, %s benched, %s removed"] = "Обновлен рейд <%s> %s игроков добавлено, %s игроков удалено, %s игроков на замене, %s игроков удалены с замены"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1257
ILM.L["Use named buttons"] = "Использовать именные кнопки"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:89
ILM.L["Vaelastrasz the Corrupt"] = "Валестраз Порочный"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:216
ILM.L["Val'kyr Twins"] = "Валь'киры Близнецы"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs___Base.lua:220
ILM.L["Valithria Dreamwalker"] = "Валитрия Сновидица"
...
ILM.L["Weekly cap"] = "Недельный лимит"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:485
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:488
ILM.L["Weekly gains"] = "За неделю"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1004
ILM.L["Weekly reset timezone"] = "Зона еженедельного сброса"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:112
ILM.L["Weekly reset"] = "Недельный сброс"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:195
ILM.L["When enabled, this will make loot announcement display only if you're Master Looter or Raid Leader (if there is no Master Looter)."] = "Когда включено, оповещения о добыче будут отображаться только если вы РЛ или МЛ (если нет МЛа)."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1258
ILM.L["Will display names of the buttons instead of values in bidding UI"] = "Будет отображать имена кнопок вместо значений в пользовательском интерфейсе"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:359
ILM.L["Will hide bidding window if you enter combat and show it again when you exit. Will also delay auto opening if needed."] = "Сможет окно торгов, если вы войдете в бой, и покажите его снова, когда вы выйдете. Также задержит автоматическое открытие, если это необходимо."
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:162
ILM.L["Wipe events"] = "Стереть события"
-- IneptLootManager/Modules/Common/Logger/Logger.lua:39
ILM.L["Wipe"] = "Стереть"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:163
ILM.L["Wipes all events from memory. This will trigger resyncing from other users."] = "Стереть все события. Это вызовет пересинхронизацию от других игроков."
-- IneptLootManager/Modules/Common/Logger/Logger.lua:40
ILM.L["Wipes the log history"] = "Стирает историю логов"
-- IneptLootManager_Integrations/Integrations.lua:363
ILM.L["WoW DKP Bot Integration"] = "Интеграция с WoW DKP Bot"
...
ILM.L["You are already in an active raid. Leave or finish it before creating new one."] = "Вы уже в активном рейде. Выйдите или завершите его перед созданием нового."
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:364
ILM.L["You are changing roster settings during active raid. You can continue without any issues however the settings will not get applied until you start a new one."] = "Вы меняете настройки списка во время активного рейда. Вы можете продолжить без каких -либо проблем, однако настройки не будут применены, пока вы не запустите новый."
...
ILM.L["You are not allowed to auction items"] = "Вам запрещено проводить аукционы"
...
ILM.L["You are not allowed to control raid."] = "Вы не можете управлять рейдом"
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:306
ILM.L["You are not allowed to create raids."] = "Вам запрещено создавать рейды."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:440
ILM.L["You are not allowed to join raid."] = "Вам запрещено присоединяться к рейдам."
...
ILM.L["You are not allowed to start raid."] = "Вам запрещено начинать рейды."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:342
ILM.L["You are not in the raid."] = "Вы не в рейде."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:700
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:709
ILM.L["You can %s max %d players from standby at the same time to a %s raid."] = "Вы можете %s макс %d игроков с замены за раз из %s рейда."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:655
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:664
ILM.L["You can %s max %d players to standby at the same time to a %s raid."] = "Вы можете %s макс %d игроков на замену за раз в %s рейд."
...
ILM.L["You can only add players to standby of a progressing raid."] = "Вы можете добавлять замены только в начавшемся рейде"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:646
ILM.L["You can only bench players from same roster as the raid (%s)."] = "Вы можете добавить на замену только игроков из того же состава, что и рейд (%s)."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:405
ILM.L["You can only end an active raid."] = "Вы можете завершать только активный рейд."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:444
ILM.L["You can only join an active raid."] = "Вы можете присоединиться только к активному рейду."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:448
ILM.L["You can only join different raid than your current one."] = "Вы можете присоединиться только к отличному от вашего рейду."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:691
ILM.L["You can only remove from bench players from same roster as the raid (%s)."] = "Вы можете удалить с замены только игроков того же состава, что и рейд (%s)."
-- IneptLootManager/Modules/Raids/RaidManager/RaidManager.lua:333
ILM.L["You can only start a freshly created raid."] = "Вы можете запустить только свежесозданный рейд."
-- IneptLootManager/Modules/GUI/UnifiedGUI_Standings.lua:743
ILM.L["You can remove max %d players from roster at the same time."] = "Вы можете удалить макс %d игроков из состава за раз."
-- IneptLootManager/Modules/Auctioning/BiddingManager/BiddingManager.lua:345
ILM.L["Your bid (%s) was denied: |cffcc0000%s|r"] = "Ваша ставка (%s) была отклонена: |cffcc0000%s|r"
-- IneptLootManager/Modules/Auctioning/BiddingManager/BiddingManager.lua:327
ILM.L["Your bid (%s) was |cff00cc00accepted|r"] = "Ваша ставка (%s) была |cff00cc00принята|r"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:64
ILM.L["Zero-Sum Bank Inflation"] = "Инфляция при нулевой сумме"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1327
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:61
ILM.L["Zero-Sum Bank"] = "Банк с нулевой суммой"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1335
ILM.L["Zero-Sum Inflation Value"] = "Значение инфляции при нулевой сумме"
-- IneptLootManager/Modules/Points/PointManager/PointManager.lua:528
ILM.L["Zero-Sum award"] = "Награда за ноль"
-- IneptLootManager/Modules/Rosters/RosterManager/Options.lua:1321
ILM.L["Zero-Sum"] = "Нулевая сумма"
-- IneptLootManager/Modules/Points/AutoAwardManager/Encounters/EncounterIDs_2_TBC.lua:88
ILM.L["Zul'Aman"] = "Зул'Аман"
...
ILM.L["|cffcc0000Your Inept Loot Manager is significantly out of date.|r AddOn communication has been disabled. Please update as soon as possible."] = "|cffcc0000Ваш Inept Loot Manager сильно устарел.|r Коммуникации аддона отключены. Пожалуйста, обновитесь как можно скорее."
end