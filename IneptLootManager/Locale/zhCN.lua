...
ILM.L["%s to be awarded to player when joining roster."] = "%s 将奖励给加入名单时的玩家。"
-- IneptLootManager/Modules/Auctioning/AutoAssign/GUI.lua:172
ILM.L["%s trade me for %s"] = "%s 交易我为 %s"
...
ILM.L["Accepting rolls on %s for %s %s"] = "接受 %s 以 %s %s 接受掷骰"
...
ILM.L["Advance to next item after bid"] = "出价后前往下一个项目"
...
ILM.L["Applies all changes and exits sandbox mode"] = "应用所有更改并退出沙盒模式"
-- IneptLootManager/Modules/GUI/UnifiedGUI_Audit.lua:653
ILM.L["Apply changes"] = "应用更改"
...
ILM.L["Are you sure, you want to bid on an unusable item %s?"] = "您确定，您想竞标不可用的项目 %s 吗？"
-- IneptLootManager/Modules/Auctioning/AuctionManager/MultiGUI.lua:360
ILM.L["Are you sure, you want to disenchant %s?"] = "您确定，您想贬低%s吗？"
-- IneptLootManager/Modules/Profiles/ProfileManager/AltMainLinkingGUI.lua:79
ILM.L["Are you sure, you want to link %s as alt of %s?"] = "您确定，您想将 %s 链接为 %s 吗？"
...
ILM.L["Automatically mark auto-removed items as disenchanted"] = "自动将自动驱动的物品标记为污点"
...
ILM.L["Case-sensitive Player name in the format: Player-RealmName"] = "案例敏感的播放器名称格式：player-realmname"
...
ILM.L["Change migration notes source"] = "更改迁移说明来源"
...
ILM.L["Comma-separated (CSV) list of disenchanter names. Case insensitive. Player-RealmName."] = "逗号分隔（CSV）删除名称列表。 不区分大小写。Player-RealmName"
...
ILM.L["Execute migration again if you are sure this is correct."] = "如果您确定这是正确的，请再次执行迁移。"
...
ILM.L["Executing migration even though ledger is not empty."] = "执行迁移，即使Ledger不是空的。"
...
ILM.L["Guild change detected. Disabling synchronisation until UI reload."] = "检测到公会变更。 禁用同步直到UI重新加载。"
...
ILM.L["Ignore unusable items"] = "忽略无法使用的项目"
...
ILM.L["Ignores unusable items. They will not be added to bidding window."] = "忽略无法使用的项目。 它们不会添加到竞标窗口中。"
...
ILM.L["Include cancels in bid list in open auction mode."] = "在开放拍卖模式下将CAMCELS包括在投标列表中。"
...
ILM.L["Include passes in bid list in open auction mode."] = "在开放拍卖模式下包括通过投标列表中的通行证。"
...
ILM.L["Moving %s from current queue to pending queue."] = "将 %s 从当前队列移动到等待队列。"
...
ILM.L["New migration source for note-based AddOns: %s"] = "基于注释的插件的新迁移源：%s"
...
ILM.L["Post all bids after awarding item"] = "授予所有投标"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:516
ILM.L["Post all bids on award"] = "发布所有出价"
...
ILM.L["Remove items without bids from auction list. This will make marking items as disenchanted not possible."] = "从拍卖列表中删除没有投标的项目。 这将使标记物品变得不可能。"
-- IneptLootManager/Modules/Auctioning/AuctionManager/AuctionManager.lua:487
ILM.L["Remove items without bids"] = "删除没有投标的项目"
...
ILM.L["Removing %s from current queue."] = "从当前队列中删除 %s。"
...
ILM.L["Restore bar defaults"] = "还原条默认值"
...
ILM.L["Select default behavior whenever group loot rolling window gets opened. This will be active only during ILM Raid and while in Raid instance."] = "每当打开“战利品掷骰”窗口时，请选择默认行为。 这仅在ILM RAID期间和在Raid实例中处于活动状态。"
...
ILM.L["Select |cffeeee00%s|r encounter difficulty for bonus value award (%s)."] = "选择|cffeee00%s |r的奖金价值奖（%s）遇到困难。"
...
ILM.L["Toggle Trade List window display"] = "切换贸易列表窗口显示"
-- IneptLootManager/Modules/Auctioning/BiddingManager/MultiGUI.lua:214
ILM.L["Toggle advancing to next item on the list after bid."] = "出价后切换到列表中的下一个项目。"
...
ILM.L["Toggle default behavior of remove on award field in auctioning ui"] = "在拍卖UI中，在奖励字段中删除删除的默认行为"
...
ILM.L["Toggles auto-rolling on cosmetics."] = "在化妆品上切换自动滚动。"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:306
ILM.L["Toggles auto-rolling on legendary items."] = "在传奇项目上切换自动掷骰。"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:330
ILM.L["Toggles auto-rolling on mounts."] = "在安装座上切换自动滚动。"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:322
ILM.L["Toggles auto-rolling on patterns."] = "在配方上切换自动掷骰。"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:314
ILM.L["Toggles auto-rolling on stacking items."] = "在可堆叠物品上切换自动掷骰。"
-- IneptLootManager/Modules/Global/GlobalConfigs.lua:338
ILM.L["Toggles auto-rolling on toys."] = "切换自动滚动玩具。"
...
ILM.L["Will hide bidding window if you enter combat and show it again when you exit. Will also delay auto opening if needed."] = "如果您输入战斗并在退出时再次显示出来，将隐藏出价窗口。 如果需要，还将延迟自动打开。"
...
ILM.L["You are changing roster settings during active raid. You can continue without any issues however the settings will not get applied until you start a new one."] = "您将在主动突袭过程中更改名册设置。 您可以继续没有任何问题，但是在开始新的问题之前，这些设置将不会应用。"
