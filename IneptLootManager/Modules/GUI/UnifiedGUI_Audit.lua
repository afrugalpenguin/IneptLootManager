...
local function GenerateOfficerOptions(self)
    return {
        toggle_sandbox = {
            ...
            type = "execute",
            func = (function() C_Timer.After(0, function() ILM.MODULES.SandboxManager:EnterSandbox() end) end),
            order = 11,
            width = 0.75,
        ...
        apply_changes = {
            ...
            type = "execute",
            func = (function() C_Timer.After(0, function() ILM.MODULES.SandboxManager:ApplyChanges() end) end),
            order = 12,
            width = 0.75,
            confirm = true,
        ...
        discard_changes = {
            ...
            type = "execute",
            func = (function() C_Timer.After(0, function() ILM.MODULES.SandboxManager:DiscardChanges() end) end),
            order = 13,
            confirm = true,
            width = 0.75,
            hidden  = (function() return not ILM.MODULES.SandboxManager:IsSandbox() end)
