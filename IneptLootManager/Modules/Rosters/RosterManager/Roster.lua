...
function Roster:New(uid, pointType, raidsForFullAttendance, attendanceWeeksWindow)
    ...
    o.configuration  = ILM.MODELS.RosterConfiguration:New()
    ...
    for id,_ in pairs(ILM.DifficultyIDsMap) do
    ...
    o.attendanceTracker = ILM.MODELS.AttendanceTracker:New(
...
function Roster:GetPointInfoForPlayer(GUID)
    return self.pointInfo[GUID] or ILM.MODELS.PointInfo:New()
end
...
function Roster:GetClassItemMultiplierValue(class, itemId)
    ...
    local equipLoc = UTILS.WorkaroundEquipLoc(classID, subclassID, itemEquipLoc)
    return self:GetSlotClassMultiplierValue(class, ILM.IndirectMap.slot[itemId] or equipLoc)
end
--[[
 *****************
 * Configuration *
...
function Roster:CopyConfiguration(s)
    self.configuration = ILM.MODELS.RosterConfiguration:New(UTILS.DeepCopy(s.configuration))
...
CONSTANTS.AUCTION_TYPES_GUI = {
    ...
    [CONSTANTS.AUCTION_TYPE.VICKREY] = ILM.L["Vickrey"],
...
CONSTANTS.INVENTORY_TYPES_SORTED = {
    { type = GLOBAL_FAKE_INVENTORY_SLOT,    name = ILM.L["Global"],            icon = 136522 },
    { type = "INVTYPE_HEAD",                name = ILM.L["Head"],              icon = 136516 },
    ...
    { type = "INVTYPE_WAIST",               name = ILM.L["Waist"],             icon = 136529 },
    { type = "INVTYPE_LEGS",                name = ILM.L["Legs"],              icon = 136517 },
    { type = "INVTYPE_FEET",                name = ILM.L["Feet"],              icon = 136513 },
    { type = "INVTYPE_FINGER",              name = ILM.L["Finger"],            icon = 136514 },
    { type = "INVTYPE_TRINKET",             name = ILM.L["Trinket"],           icon = 136528 },
    { type = "INVTYPE_WEAPON",              name = ILM.L["One-Hand"],          icon = 136518 },
    { type = "INVTYPE_WEAPONMAINHAND",      name = ILM.L["Main Hand"],         icon = 136518 },
    { type = "INVTYPE_WEAPONOFFHAND",       name = ILM.L["Off Hand"],          icon = 136524 },
    { type = "INVTYPE_HOLDABLE",            name = ILM.L["Held In Off-hand"],  icon = 136524 },
    { type = "INVTYPE_2HWEAPON",            name = ILM.L["Two-Hand"],          icon = 136518 },
    { type = "INVTYPE_SHIELD",              name = ILM.L["Shield"],            icon = 136524 },
    { type = "INVTYPE_RANGED",              name = ILM.L["Ranged"],            icon = 136520 },
    { type = "INVTYPE_RANGEDRIGHT",         name = ILM.L["Ranged (wands)"],    icon = 136520 },
...
CONSTANTS.INVENTORY_TYPES_GUI = {
    [GLOBAL_FAKE_INVENTORY_SLOT] = ILM.L["Global"],
    ["INVTYPE_HEAD"] = ILM.L["Head"],
    ["INVTYPE_NECK"] = ILM.L["Neck"],
    ["INVTYPE_SHOULDER"] = ILM.L["Shoulder"],
    ["INVTYPE_BODY"] = ILM.L["Shirt"],
    ["INVTYPE_CLOAK"] = ILM.L["Back"],
    ["INVTYPE_CHEST"] = ILM.L["Chest"],
    ["INVTYPE_ROBE"] = ILM.L["Chest (robes)"],
    ["INVTYPE_TABARD"] = ILM.L["Tabard"],
    ["INVTYPE_WRIST"] = ILM.L["Wrist"],
    ["INVTYPE_HAND"] = ILM.L["Hands"],
    ["INVTYPE_WAIST"] = ILM.L["Waist"],
    ["INVTYPE_LEGS"] = ILM.L["Legs"],
    ["INVTYPE_FEET"] = ILM.L["Feet"],
    ["INVTYPE_FINGER"] = ILM.L["Finger"],
    ["INVTYPE_TRINKET"] = ILM.L["Trinket"],
    ["INVTYPE_WEAPON"] = ILM.L["One-Hand"],
    ["INVTYPE_WEAPONMAINHAND"] = ILM.L["Main Hand"],
    ["INVTYPE_WEAPONOFFHAND"] = ILM.L["Off Hand"],
    ["INVTYPE_HOLDABLE"] = ILM.L["Held In Off-hand"],
    ["INVTYPE_2HWEAPON"] = ILM.L["Two-Hand"],
    ["INVTYPE_SHIELD"] = ILM.L["Shield"],
    ["INVTYPE_RANGED"] = ILM.L["Ranged"],
    ["INVTYPE_RANGEDRIGHT"] = ILM.L["Ranged (wands)"],
    ["INVTYPE_NON_EQUIP"] = ILM.L["Non-equippable"],
    ["INVTYPE_BAG"] = ILM.L["Bag"],
    ["INVTYPE_AMMO"] = ILM.L["Ammo"],
    ["INVTYPE_THROWN"] = ILM.L["Thrown"],
    ["INVTYPE_QUIVER"] = ILM.L["Quiver"],
    ["INVTYPE_RELIC"] = ILM.L["Relic"]
}
...
CONSTANTS.WEEKLY_RESETS_GUI = {
    [CONSTANTS.WEEKLY_RESET.EU] = ILM.L["Europe"],
    [CONSTANTS.WEEKLY_RESET.US] = ILM.L["Americas"]
}
